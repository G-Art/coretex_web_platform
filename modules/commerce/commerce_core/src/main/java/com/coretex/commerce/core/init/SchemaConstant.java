...
public class SchemaConstant {
	...
	public static final Map<String, Map<String, String>> COUNTRY_CONFIG = new HashMap<>();
	static {
		COUNTRY_CONFIG.put("US", Map.of("languages", "en", "currency", "USD", "name", "en:United State of America,ru:США,ua:США"));
		COUNTRY_CONFIG.put("FR", Map.of("languages", "fr,en", "currency", "EUR", "name", "en:France,ru:Францыя,ua:Франція"));
		COUNTRY_CONFIG.put("RU", Map.of("languages", "ru,en", "currency", "RUB", "name", "en:Russia,ru:Россия,ua:Россія"));
		COUNTRY_CONFIG.put("UA", Map.of("languages", "ru,ua,en", "currency", "UAH", "name", "en:Ukrainian,ru:Украина,ua:Україна"));
	}

	/**
	 * Languages iso codes
	 */
	public static final String[] LANGUAGE_ISO_CODE = {"en", "fr", "ru", "ua"};
	...
	static {
		...
		LOCALES.put("UA", LocaleUtils.toLocale("ua"));
	}

	/**
	 * CurrencyItem codes with name
	 */
