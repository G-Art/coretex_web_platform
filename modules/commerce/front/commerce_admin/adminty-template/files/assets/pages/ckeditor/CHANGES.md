...
* Updated [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) and [SpellCheckAsYouType](https://ckeditor.com/cke4/addon/scayt) (SCAYT) plugins:
	* LanguageData dictionary update: German language was extended with over 600k new words.
	* LanguageData dictionary update: Swedish language was extended with over 300k new words.
...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) plugins:
	* LanguageData dictionary update: Added support for the Uzbek Latin language.
...
* [#779](https://github.com/ckeditor/ckeditor-dev/issues/779): Fixed: The [Remove Format](https://ckeditor.com/cke4/addon/removeformat) plugin removes elements with language definition inserted by the [LanguageData](https://ckeditor.com/cke4/addon/language) plugin.
...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) plugins:
	* Fixed: DOM Exception after clicking "Remove LanguageData" on a selected word with enabled [LanguageData](https://ckeditor.com/cke4/addon/language) plugin in SCAYT.
...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type):
	- New features:
		- CKEditor [LanguageData](https://ckeditor.com/cke4/addon/language) plugin support.
...
* To match the naming convention, the `language` button is now `LanguageData` ([#11201](https://dev.ckeditor.com/ticket/11201)).
...
* [#11044](https://dev.ckeditor.com/ticket/11044): Enhanced WAI-ARIA support for the [LanguageData](https://ckeditor.com/cke4/addon/language) plugin drop-down menu.
...
* [#10856](https://dev.ckeditor.com/ticket/10856): Menu buttons will now toggle the visibility of their panels when clicked multiple times. [LanguageData](https://ckeditor.com/cke4/addon/language) plugin fixes: Added active language highlighting, added an option to remove the language.
...
* [#10848](https://dev.ckeditor.com/ticket/10848): Integrate remaining plugins ([Styles](https://ckeditor.com/cke4/addon/stylescombo), [Format](https://ckeditor.com/cke4/addon/format), [Font](https://ckeditor.com/cke4/addon/font), [Color Button](https://ckeditor.com/cke4/addon/colorbutton), [LanguageData](https://ckeditor.com/cke4/addon/language) and [Indent](https://ckeditor.com/cke4/addon/indent)) with [active filter](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#property-activeFilter).
...
* [#7987](https://dev.ckeditor.com/ticket/7987): New [LanguageData](https://ckeditor.com/cke4/addon/language) plugin that implements LanguageData toolbar button to support [WCAG 3.1.2 LanguageData of Parts](http://www.w3.org/TR/UNDERSTANDING-WCAG20/meaning-other-lang-id.html).
