...
$(document).ready(function () {
    ...
    let removeItems = document.querySelector('.removeItem');
    if (removeItems) {
        removeItems.onclick = function (event) {
            let target = event.target;
            let requestUrl = target.dataset.requestUrl;
            removeItemModalPanel(requestUrl)
        };
    }
});
...
function removeItemModalPanel(requestUrl) {
    swal({
        title: "Remove this item?",
        text: "Please confirm item removing",
        type: "warning",
