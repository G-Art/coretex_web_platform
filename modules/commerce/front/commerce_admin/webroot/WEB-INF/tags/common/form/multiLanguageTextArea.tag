...
<div class="accordion-block">
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="accordion-panel">
            ...
            <div id="collapse${name}One" class="panel-collapse in collapse" role="tabpanel"
                 aria-labelledby="heading${name}One"
                 style="">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <textarea name="${name}['${loc.isocode}']"
                                              id="${status.index}_${name}_${loc.isocode}"
                                              class="form-control"
                                              placeholder="${placeholder}">${dataMap[loc.isocode]}</textarea>
...
<%--                                InlineEditor--%>
<%--                                    .create(document.getElementById('${status.index}_${name}_${loc.isocode}'))--%>
<%--                                    .catch(error => {--%>
<%--                                        console.log(error);--%>
<%--                                    });--%>
<%--                            });--%>
