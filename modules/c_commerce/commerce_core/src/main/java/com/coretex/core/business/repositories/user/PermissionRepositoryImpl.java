...
public class PermissionRepositoryImpl implements PermissionRepositoryCustom {
	...
	public PermissionList listByCriteria(PermissionCriteria criteria) {
		...
		countBuilderSelect.append("select count(p) from PermissionItem as p");
...
//        	return permissionList;
		...
		qs.append("select p from PermissionItem as p ");
...
//		List<PermissionItem> permissions =  q.getResultList();
