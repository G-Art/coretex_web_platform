...
public class IntegrationModulesLoader {
	...
	public List<IntegrationModuleItem> loadIntegrationModules(String jsonFilePath) throws Exception {


		List<IntegrationModuleItem> modules = new ArrayList<IntegrationModuleItem>();
	...
	public IntegrationModuleItem loadModule(Map object) throws Exception {

		ObjectMapper mapper = new ObjectMapper();
		IntegrationModuleItem module = new IntegrationModuleItem();
