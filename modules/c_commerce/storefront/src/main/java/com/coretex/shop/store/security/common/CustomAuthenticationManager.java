package com.coretex.shop.store.security.common;
...
public abstract class CustomAuthenticationManager {
	...
	public abstract Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws Exception;
