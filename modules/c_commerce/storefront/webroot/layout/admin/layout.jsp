...
<div>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span4"><a class="brand" href="#"></a></div>
                        ...
                        <ul class="nav pull-right" style="z-index:500000;position:relative">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<c:url value="/admin/users/displayUser.html" />"><s:message
                                            code="label.my.profile" text="My profile"/></a></li>
                                    <li class="divider"></li>
                                    <li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <c:forEach items="${requestScope.ADMIN_STORE.languages}" var="lang">
                                            <li><a href="<c:url value="/admin?locale=${lang.code}" />"><s:message
                                                    code="${lang.code}" text="${lang.code}"/></a></li>
                                        </c:forEach>
                                    </ul>
    ...
    <div class="container">
        ...
        <footer>
            ...
            <p>&copy; GoodMood 2019 - <c:out value="${currentYear}" />
            </p>
        </footer>
