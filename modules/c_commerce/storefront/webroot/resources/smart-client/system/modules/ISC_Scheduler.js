...
if (window.isc && window.isc.module_Core && !window.isc.module_SQLBrowser) {
    ...
    isc.A.jobsPauseBtnDefaults = {
        ...
        click: function () {
            var _1 = this.creator.jobsGrid;
            if (!_1.anySelected()) {
                isc.say("Please select a job first");
                return
            }
            var _2 = _1.getSelectedRecord();
            var _3 = this;
            QuartzJobs.performCustomOperation("pauseJob", {group: _2.group, name: _2.name}, function (_4) {
                _3.creator.triggersGrid.invalidateCache();
                isc.say('Job Paused')
            })
        }
    };
    isc.A.jobsResumeBtnDefaults = {
        ...
        click: function () {
            ...
            var _2 = _1.getSelectedRecord();
            var _3 = this;
            QuartzJobs.performCustomOperation("resumeJob", {group: _2.group, name: _2.name}, function (_4) {
                _3.creator.triggersGrid.invalidateCache();
                isc.say('Job Resumed')
            })
        }
    ...
    isc.A.jobsTriggerBtnDefaults = {
        _constructor: "IButton", title: "Trigger Job", prompt: "Triggers selected job immediately", click: function () {
            var _1 = this.creator.jobsGrid;
            if (!_1.anySelected()) {
                isc.say("Please select a job first");
                return
            ...
            var _2 = _1.getSelectedRecord();
            QuartzJobs.performCustomOperation("triggerJob", {group: _2.group, name: _2.name}, function (_3) {
    ...
    isc.A.jobsRemoveBtnDefaults = {
        ...
        click: function () {
            var _1 = this;
            isc.ask("Are you sure you wish to delete the selected job?  This will remove all" + " triggers associated with this job.", function (_2) {
                if (_2) _1.creator.jobsGrid.removeSelectedData(function (_3) {
                    _1.creator.triggersGrid.setData([])
                })
            })
        }
    };
    isc.A.jobsGridDefaults = {
        ...
        recordDoubleClick: function () {
            isc.say("The Quartz APIs do not allow modification of job metadata without destroying" + " all triggers attached to the job, so you must remove and re-create the job if" + " that's your intention");
            return
        },
        selectionChanged: function (_1, _2) {
            if (_2) {
                this.creator.triggersGrid.filterData({jobGroup: _1.group, jobName: _1.name})
            } else {
                this.creator.triggersGrid.setData([])
            }
        },
    ...
    isc.A.triggersPauseBtnDefaults = {
        _constructor: "IButton", title: "Pause Trigger", prompt: "Suspends selected trigger", click: function () {
            var _1 = this.creator.triggersGrid;
            if (!_1.anySelected()) {
                isc.say("Please select a trigger first");
                return
            }
            var _2 = _1.getSelectedRecord();
            QuartzTriggers.performCustomOperation("pauseTrigger", {group: _2.group, name: _2.name}, function (_3) {
                _1.invalidateCache();
    ...
    isc.A.triggersResumeBtnDefaults = {
        _constructor: "IButton", title: "Resume Trigger", prompt: "Resumes selected trigger", click: function () {
            var _1 = this.creator.triggersGrid;
            if (!_1.anySelected()) {
                isc.say("Please select a trigger first");
                return
            ...
            var _2 = _1.getSelectedRecord();
            QuartzTriggers.performCustomOperation("resumeTrigger", {group: _2.group, name: _2.name}, function (_3) {
                _1.invalidateCache();
    ...
    isc.A.triggersAddBtnDefaults = {
        ...
        click: function () {
            ...
            var _2 = _1.getSelectedRecord();
            this.creator.triggersGrid.startEditingNew({jobGroup: _2.group, jobName: _2.name})
        }
    };
    isc.A.triggersRemoveBtnDefaults = {
        ...
        click: function () {
            var _1 = this;
            isc.ask("Are you sure you wish to remove the selected trigger?", function (_2) {
                if (_2) _1.creator.jobsGrid.removeSelectedData(function (_3) {
                    _1.creator.triggersGrid.invalidateCache()
                })
            })
        }
    };
