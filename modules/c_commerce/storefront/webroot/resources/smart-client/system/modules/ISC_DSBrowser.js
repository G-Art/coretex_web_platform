...
if (window.isc && window.isc.module_Core && !window.isc.module_DSBrowser) {
    isc.module_DSBrowser = 1;
    isc._moduleStart = isc._DSBrowser_start = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {
            message: 'DSBrowser load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms',
            category: 'loadTime'
        };
    ...
    isc.defineClass("DSRegistryList", "ListGrid");
    ...
    isc.D = isc._funcClasses;
    isc.D[isc.C] = isc.A.Class;
    isc.B.push(isc.A.showWindow = function isc_c_DSBrowser_showWindow(_1, _2) {
            isc.Window.create({
                title: "DS Builder",
                width: "100%",
                height: "100%",
                ...
                items: [isc.DSBrowser.create({autoDraw: false}, _2)]
            }, _1).show()
        }
    );
    isc.B._maxIndex = isc.C + 1;
    ...
    isc.A.dsRegistryListDefaults = {
        ...
        autoFetchData: true,
        canHover: true,
        defaultFields: [{name: "ID", title: "Name"}],
    ...
    isc.A.dsRegistryPaneDefaults = {_constructor: "DSRegistryPane"};
    isc.B.push(isc.A.initWidget = function isc_DSBrowser_initWidget() {
            ...
            this.leftSection = this.createAutoChild("leftSection", {
                sections: [{
                    name: "registries",
                    title: "DataSource Registries",
                    expanded: true,
                    controls: [this.dsRegistryListRefreshButton],
                    items: [this.dsRegistryList]
                }, {
                    name: "datasources",
                    title: "DataSources",
                    expanded: true,
                    controls: [this.dsListAddButton, this.dsListRemoveButton, this.dsListRefreshButton],
                    items: [this.dsList]
                }]
            });
        ...
        , isc.A.dsRegistryChanged = function isc_DSBrowser_dsRegistryChanged(_1) {
            this.currentRegistry = _1;
            isc.DMI.call("isc_builtin", "com.isomorphic.tools.BuiltinRPC", "dsFromXML", _1.object, this.getID() + ".dsLoaded(data)")
        }
        , isc.A.dsLoaded = function isc_DSBrowser_dsLoaded(_1) {
            this.currentDS = _1;
            this.showDSRegistryPane();
            this.dsList.setDataSource(_1);
            this.dsList.setFields([{name: "ID", title: "Name"}]);
            this.dsList.filterData()
        }
        , isc.A.showDSRegistryPane = function isc_DSBrowser_showDSRegistryPane() {
            var _1 = this.currentRegistry;
            this.showPane({
                ID: this.escapeForId("registryPane_" + _1.ID),
                title: _1.ID,
                paneClass: "dsRegistryPane"
            }, _1)
        }
        , isc.A.dsChanged = function isc_DSBrowser_dsChanged(_1) {
            this.currentDS = _1;
            this.showDSPane()
        }
        , isc.A.showDSPane = function isc_DSBrowser_showDSPane() {
            var _1 = this.currentDS;
            this.showDSRegistryPane();
            var _2 = {};
            isc.addProperties(_2, _1, {registry: isc.clone(this.currentRegistry)});
            this.currentPane.showDSPane(_2)
        }
        , isc.A.escapeForId = function isc_DSBrowser_escapeForId(_1) {
            return isc.isA.String(_1) ? _1.replace(/(\/|\.)/g, '_') : _1
        }
        , isc.A.showPane = function isc_DSBrowser_showPane(_1, _2) {
    ...
    isc.D = isc._funcClasses;
    isc.D[isc.C] = isc.A.Class;
    isc.A.dsPaneDefaults = {_constructor: "DSEditor"};
    isc.B.push(isc.A.initWidget = function isc_DSRegistryPane_initWidget() {
            this.Super("initWidget", arguments)
        }
        , isc.A.showDSPane = function isc_DSRegistryPane_showDSPane(_1) {
            var _2 = this.escapeForId("dsPane_" + this.config.ID + '_' + _1.ID);
            this.showPane({ID: _2, title: _1.ID, paneClass: "dsPane"}, _1)
        }
        , isc.A.escapeForId = function isc_DSRegistryPane_escapeForId(_1) {
            return isc.isA.String(_1) ? _1.replace(/(\/|\.)/g, '_') : _1
        }
        , isc.A.showPane = function isc_DSRegistryPane_showPane(_1, _2) {
    ...
    isc.A.dbListDefaults = {_constructor: "DBCompactList"};
    isc.A.showSQLBrowserButtonDefaults = {
        _constructor: "IButton",
        title: "Show SQL Browser",
        width: 150,
        click: function () {
            isc.SQLBrowser.showWindow({width: "95%", height: "95%", isModal: true, autoCenter: true})
        }
    };
    isc.A.fetchOperationFormDefaults = {
        ...
        fields: [{
            ...
            width: "*",
            colSpan: "*",
            defaultValue: "$defaultWhereClause"
        }, {
            name: "groupClause",
            title: "GROUP BY",
            formItemType: "AutoFitTextAreaItem",
            ...
            width: "*",
            colSpan: "*",
            defaultValue: "$defaultGroupClause"
        }, {
            name: "orderClause",
            title: "ORDER BY",
            formItemType: "AutoFitTextAreaItem",
            ...
            width: "*",
            colSpan: "*",
            defaultValue: "$defaultOrderClause"
        }]
    };
    isc.A.actionBarDefaults = {_constructor: "HLayout", height: 20};
    ...
    isc.B.push(isc.A.initWidget = function isc_DSEditor_initWidget() {
            ...
            this.fieldGrid = this.createAutoChild("fieldGrid", {
                fields: [{name: "title", title: "Title"}, {
                    name: "name",
                    title: "Name"
                }, {name: "width", title: "Width"}, {name: "height", title: "Height"}, {
                    name: "operator",
                    title: "Operator",
                    valueMap: ["equals", "notEqual", "greaterThan", "lessThan", "greaterOrEqual", "lessOrEqual", "contains", "startsWith", "endsWith", "iContains", "iStartsWith", "iEndsWith", "notContains", "notStartsWith", "notEndsWith", "iNotContains", "iNotStartsWith", "iNotEndsWith", "regexp", "iregexp", "isNull", "notNull", "inSet", "notInSet", "equalsField", "notEqualField", "and", "not", "or", "between", "betweenInclusive"]
                }, {name: "formItemType", title: "Form Item Type"}, {name: "tableName", title: "Table Name"}, {
                    name: "type",
                    title: "Type"
                }]
            });
        ...
        , isc.A.deriveDSLoaded = function isc_DSEditor_deriveDSLoaded(_1) {
            var _2 = _1.ds;
            this.dsLoaded(_1.ds)
        }
        , isc.A.loadDS = function isc_DSEditor_loadDS(_1) {
            this.currentRegistry = _1;
            isc.DMI.call("isc_builtin", "com.isomorphic.tools.BuiltinRPC", "dsConfigFromXML", _1.object, this.getID() + ".dsLoaded(data)")
        }
        , isc.A.dsLoaded = function isc_DSEditor_dsLoaded(_1) {
            var _2 = isc.DataSource.create(_1);
            this.currentDS = _2;
            _2.repo = this.config.registry.ID;
            this.deriveFields(_2);
            this.previewGrid.setDataSource(_2);
            if (_2.dbName) this.dbList.setSelectedDB(_2.dbName);
            var _3 = _2.operationBindings;
            if (_3 && _3.length > 0) {
                this.fetchOperationForm.setValues(_3[0])
            }
        }
        , isc.A.deriveFields = function isc_DSEditor_deriveFields(_1) {
        ...
        , isc.A.tryIt = function isc_DSEditor_tryIt() {
            var _1 = this.buildDSConfig(this.config.ID + "$71x");
            var _2 = isc.DataSource.get("DataSourceStore");
            _2.performCustomOperation("dsFromConfig", {config: _1}, this.getID() + ".tryItCallback(data)")
        }
        , isc.A.tryItCallback = function isc_DSEditor_tryItCallback(_1) {
            this.expandSection("preview");
            this.previewGrid.setDataSource(_1.ds);
            this.previewGrid.filterData()
        }
        , isc.A.saveDS = function isc_DSEditor_saveDS() {
            var _1 = this.buildDSConfig(this.config.ID);
            var _2 = isc.DataSource.get("DataSourceStore");
            _2.performCustomOperation("dsFromConfig", {config: _1}, this.getID() + ".xmlLoaded(data)")
        }
        , isc.A.xmlLoaded = function isc_DSEditor_xmlLoaded(_1) {
            var _2 = isc.DataSource.get(this.config.registry.ID);
            _2.updateData({pk: this.config.pk, object: _1.dsXML})
        }
        , isc.A.buildDSConfig = function isc_DSEditor_buildDSConfig(_1) {
            var _2 = {
                ID: _1,
                serverType: "sql",
                dbName: this.dbList.getSelectedDB(),
                ...
                }, this.fetchOperationForm.getValues())],
    ...
    isc._moduleEnd = isc._DSBrowser_end = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) isc.Log.logInfo('DSBrowser module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn) isc.Log.logWarn("Duplicate load of module 'DSBrowser'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
