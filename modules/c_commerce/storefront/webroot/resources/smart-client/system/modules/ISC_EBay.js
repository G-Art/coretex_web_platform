...
if (window.isc && window.isc.module_Core && !window.isc.module_EBay) {
    isc.module_EBay = 1;
    isc._moduleStart = isc._EBay_start = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {
            message: 'EBay load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms',
            category: 'loadTime'
        };
    ...
    isc.SchemaSet.create({
        ...
        schema: [isc.XSElement.create({
            ...
            fields: {DisputeID: {name: "DisputeID", type: "DisputeIDType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {Item: {name: "Item", type: "ItemType", xmlRequired: false}},
            ...
            fields: {
                AddMemberMessagesAAQToBidderRequestContainer: {
                    name: "AddMemberMessagesAAQToBidderRequestContainer",
            ...
            fields: {
                AddMemberMessagesAAQToBidderResponseContainer: {
                    name: "AddMemberMessagesAAQToBidderResponseContainer",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {Order: {name: "Order", type: "OrderType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {ItemID: {name: "ItemID", type: "ItemIDType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {EndTime: {name: "EndTime", type: "dateTime", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {SecretID: {name: "SecretID", type: "string", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {ApiAccessRule: {name: "ApiAccessRule", type: "ApiAccessRuleType", xmlRequired: false}},
            ...
            fields: {
                ...
                IncludeCategoryMappingDetails: {
                    name: "IncludeCategoryMappingDetails",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {XSLFile: {name: "XSLFile", type: "XSLFileType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Cart: {name: "Cart", type: "CartType", xmlRequired: false}},
            ...
            fields: {
                ...
                SiteWideCharacteristicSets: {
                    name: "SiteWideCharacteristicSets",
            ...
            fields: {
                ...
                CategoryFinanceOfferArray: {
                    name: "CategoryFinanceOfferArray",
            ...
            mustQualify: true, useParentFieldOrder: true, inheritsFrom: "AbstractRequestType", fields: {
            ...
            fields: {
                ...
                RelatedSearchKeywordArray: {
                    name: "RelatedSearchKeywordArray",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {CategoryVersion: {name: "CategoryVersion", type: "string", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Charity: {name: "Charity", type: "CharityInfoType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {CrossPromotion: {name: "CrossPromotion", type: "CrossPromotionsType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Dispute: {name: "Dispute", type: "DisputeType", xmlRequired: false}},
            ...
            fields: {
                GetRecommendationsRequestContainer: {
                    name: "GetRecommendationsRequestContainer",
            ...
            fields: {
                GetRecommendationsResponseContainer: {
                    name: "GetRecommendationsResponseContainer",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {ShippingDetails: {name: "ShippingDetails", type: "ShippingDetailsType", xmlRequired: false}},
            ...
            fields: {
                ...
                ReturnedTransactionCountActual: {
                    name: "ReturnedTransactionCountActual",
                    type: "int",
                    xmlRequired: false
                },
                Item: {name: "Item", type: "ItemType", xmlRequired: false},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {ASQPreferences: {name: "ASQPreferences", type: "ASQPreferencesType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {PreferenceLevel: {name: "PreferenceLevel", type: "NotificationRoleCodeType", xmlRequired: false}},
            ...
            fields: {
                ApplicationDeliveryPreferences: {
                    name: "ApplicationDeliveryPreferences",
                    type: "ApplicationDeliveryPreferencesType",
                    xmlRequired: false
                },
                UserDeliveryPreferenceArray: {
                    name: "UserDeliveryPreferenceArray",
            ...
            fields: {
                ...
                NotificationDetailsArray: {
                    name: "NotificationDetailsArray",
                    type: "NotificationDetailsArrayType",
                    xmlRequired: false
                },
                MarkUpMarkDownHistory: {
                    name: "MarkUpMarkDownHistory",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {OrderArray: {name: "OrderArray", type: "OrderArrayType", xmlRequired: false}},
            ...
            fields: {
                ...
                PictureManagerDetailLevel: {
                    name: "PictureManagerDetailLevel",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {ProductSearch: {name: "ProductSearch", type: "ProductSearchType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {ProductSellingPagesData: {name: "ProductSellingPagesData", type: "string", xmlRequired: false}},
            ...
            fields: {
                CharacteristicsSetProductHistogram: {
                    name: "CharacteristicsSetProductHistogram",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {PromotionalSaleID: {name: "PromotionalSaleID", type: "long", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {ClientUseCase: {name: "ClientUseCase", type: "string", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {RuName: {name: "RuName", type: "string", xmlRequired: false}},
            ...
            mustQualify: true, useParentFieldOrder: true, inheritsFrom: "AbstractResponseType", fields: {
                SearchResultItemArray: {
                    name: "SearchResultItemArray",
                ...
                InternationalExpansionArray: {
                    name: "InternationalExpansionArray",
                    type: "ExpansionArrayType",
                    xmlRequired: false
                },
                FilterRemovedExpansionArray: {
                    name: "FilterRemovedExpansionArray",
                    type: "ExpansionArrayType",
                    xmlRequired: false
                },
                AllCategoriesExpansionArray: {
                    name: "AllCategoriesExpansionArray",
                    type: "ExpansionArrayType",
                    xmlRequired: false
                },
            ...
            fields: {
                ...
                FlatShippingDiscount: {
                    name: "FlatShippingDiscount",
                    type: "FlatShippingDiscountType",
                    xmlRequired: false
                },
                CalculatedShippingDiscount: {
                    name: "CalculatedShippingDiscount",
                ...
                CalculatedHandlingDiscount: {
                    name: "CalculatedHandlingDiscount",
                    type: "CalculatedHandlingDiscountType",
                    xmlRequired: false
                },
                PromotionalShippingDiscountDetails: {
                    name: "PromotionalShippingDiscountDetails",
                ...
                InternationalShippingInsurance: {
                    name: "InternationalShippingInsurance",
                    type: "ShippingInsuranceType",
                    xmlRequired: false
                },
                CombinedDuration: {name: "CombinedDuration", type: "CombinedPaymentPeriodCodeType", xmlRequired: false}
            },
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Store: {name: "Store", type: "StoreType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {TaskID: {name: "TaskID", type: "long", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Status: {name: "Status", type: "TaskStatusCodeType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {PageID: {name: "PageID", type: "long", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {CustomPageArray: {name: "CustomPageArray", type: "StoreCustomPageArrayType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {StorePreferences: {name: "StorePreferences", type: "StorePreferencesType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {Query: {name: "Query", type: "string", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {User: {name: "User", type: "UserType", xmlRequired: false}},
            ...
            fields: {
                ShowBidderNoticePreferences: {
                    name: "ShowBidderNoticePreferences",
                    type: "boolean",
                    xmlRequired: true
                },
                ShowCombinedPaymentPreferences: {
                    name: "ShowCombinedPaymentPreferences",
                    type: "boolean",
                    xmlRequired: true
                },
                ShowCrossPromotionPreferences: {
                    name: "ShowCrossPromotionPreferences",
                    type: "boolean",
                    xmlRequired: true
                },
                ShowSellerPaymentPreferences: {
                    name: "ShowSellerPaymentPreferences",
                    type: "boolean",
                    xmlRequired: true
                },
                ShowEndOfAuctionEmailPreferences: {
                    name: "ShowEndOfAuctionEmailPreferences",
                    type: "boolean",
                    xmlRequired: false
                },
                ShowSellerFavoriteItemPreferences: {
                    name: "ShowSellerFavoriteItemPreferences",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            fields: {
                ...
                VeROReportPacketStatus: {
                    name: "VeROReportPacketStatus",
                    type: "VeROReportPacketStatusCodeType",
                    xmlRequired: false
                },
                ReportedItemDetails: {
                    name: "ReportedItemDetails",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {PostID: {name: "PostID", type: "ItemIDType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {WantItNowPost: {name: "WantItNowPost", type: "WantItNowPostType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {DetailName: {name: "DetailName", type: "DetailNameCodeType", xmlRequired: false}},
            ...
            fields: {
                ...
                SellerItemRatingDetailArray: {
                    name: "SellerItemRatingDetailArray",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {FeedbackID: {name: "FeedbackID", type: "string", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {SellingStatus: {name: "SellingStatus", type: "SellingStatusType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {RespondToBestOffer: {name: "RespondToBestOffer", type: "BestOfferArrayType", xmlRequired: false}},
            ...
            fields: {
                ...
                InternationalShippingServiceOptions: {
                    name: "InternationalShippingServiceOptions",
            ...
            fields: {
                ...
                PromotionalSaleItemIDArray: {
                    name: "PromotionalSaleItemIDArray",
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {Status: {name: "Status", type: "PromotionalSaleStatusCodeType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {CustomPage: {name: "CustomPage", type: "StoreCustomPageType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractRequestType",
            fields: {TaxTable: {name: "TaxTable", type: "TaxTableType", xmlRequired: false}},
            ...
            useParentFieldOrder: true,
            inheritsFrom: "AbstractResponseType",
            fields: {ValidToken: {name: "ValidToken", type: "boolean", xmlRequired: false}},
            ...
            fields: {
                ...
                DuplicateInvocationDetails: {
                    name: "DuplicateInvocationDetails",
            ...
            valueMap: ["None", "MOCC", "AmEx", "PaymentSeeDescription", "CCAccepted", "PersonalCheck", "COD", "VisaMC", "PaisaPayAccepted", "Other", "PayPal", "Discover", "CashOnPickup", "MoneyXferAccepted", "MoneyXferAcceptedInCheckout", "OtherOnlinePayments", "Escrow", "PrePayDelivery", "CODPrePayDelivery", "PostalTransfer", "CustomCode", "LoanCheck", "CashInPerson", "ELV"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["ReturnAll", "ItemReturnDescription", "ItemReturnAttributes", "ItemReturnCategories", "ReturnSummary", "ReturnHeaders", "ReturnMessages"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "DisputeActivityCodeType",
            valueMap: ["SellerAddInformation", "SellerCompletedTransaction", "CameToAgreementNeedFVFCredit", "SellerEndCommunication", "MutualAgreementOrNoBuyerResponse", "SellerOffersRefund", "SellerShippedItem", "SellerComment", "SellerPaymentNotReceived", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["BuyerHasNotResponded", "BuyerRefusedToPay", "BuyerNotClearedToPay", "BuyerReturnedItemForRefund", "UnableToResolveTerms", "BuyerNoLongerWantsItem", "BuyerPurchasingMistake", "ShipCountryNotSupported", "ShippingAddressNotConfirmed", "PaymentMethodNotSupported", "BuyerNoLongerRegistered", "OtherExplanation", "Unspecified", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["AllInvolvedDisputes", "DisputesAwaitingMyResponse", "DisputesAwaitingOtherPartyResponse", "AllInvolvedClosedDisputes", "EligibleForCredit", "UnpaidItemDisputes", "ItemNotReceivedDisputes", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "string",
            name: "DisputeIDType"
        }), isc.SimpleType.create({
            ...
            valueMap: ["BuyerHasNotPaid", "TransactionMutuallyCanceled", "ItemNotReceived", "SignificantlyNotAsDescribed", "NoRefund", "ReturnPolicyUnpaidItem", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["Unresolved", "ProofOfPayment", "ComputerTechnicalProblem", "NoContact", "FamilyEmergency", "ProofGivenInFeedback", "FirstInfraction", "CameToAgreement", "ItemReturned", "BuyerPaidAuctionFees", "SellerReceivedPayment", "OtherResolution", "ClaimPaid", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "DisputeResolutionRecordTypeCodeType",
            valueMap: ["StrikeBuyer", "SuspendBuyer", "FVFCredit", "InsertionFeeCredit", "AppealBuyerStrike", "UnsuspendBuyer", "ReverseFVFCredit", "ReverseInsertionFeeCredit", "GenerateCSTicketForSuspend", "FVFCreditNotGranted", "ItemNotReceivedClaimFiled", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["None", "DisputeCreatedTimeAscending", "DisputeCreatedTimeDescending", "DisputeStatusAscending", "DisputeStatusDescending", "DisputeCreditEligibilityAscending", "DisputeCreditEligibilityDescending", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "DisputeStateCodeType",
            valueMap: ["Locked", "Closed", "BuyerFirstResponsePayOption", "BuyerFirstResponseNoPayOption", "BuyerFirstResponsePayOptionLateResponse", "BuyerFirstResponseNoPayOptionLateResponse", "MutualCommunicationPayOption", "MutualCommunicationNoPayOption", "PendingResolve", "MutualWithdrawalAgreement", "MutualWithdrawalAgreementLate", "NotReceivedNoSellerResponse", "NotAsDescribedNoSellerResponse", "NotReceivedMutualCommunication", "NotAsDescribedMutualCommunication", "MutualAgreementOrBuyerReturningItem", "ClaimOpened", "NoDocumentation", "ClaimClosed", "ClaimDenied", "ClaimPending", "ClaimPaymentPending", "ClaimPaid", "ClaimResolved", "ClaimSubmitted", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "DisputeStatusCodeType",
            valueMap: ["Closed", "WaitingForSellerResponse", "WaitingForBuyerResponse", "ClosedFVFCreditStrike", "ClosedNoFVFCreditStrike", "ClosedFVFCreditNoStrike", "ClosedNoFVFCreditNoStrike", "StrikeAppealedAfterClosing", "FVFCreditReversedAfterClosing", "StrikeAppealedAndFVFCreditReversed", "ClaimOpened", "NoDocumentation", "ClaimClosed", "ClaimDenied", "ClaimInProcess", "ClaimApproved", "ClaimPaid", "ClaimResolved", "ClaimSubmitted", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["NotSet", "HourlyLimitExceeded", "DailyLimitExceeded", "PeriodicLimitExceeded", "HourlySoftLimitExceeded", "DailySoftLimitExceeded", "PeriodicSoftLimitExceeded", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
            ...
            mustQualify: true,
            fields: {
                currencyID: {name: "currencyID", type: "CurrencyCodeType", xmlRequired: true, xmlAttribute: true},
            ...
            mustQualify: true,
            fields: {Attribute: {name: "Attribute", type: "AttributeType", xmlRequired: false}},
            ID: "AttributeArrayType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {AttributeSetArray: {name: "AttributeSetArray", type: "AttributeSetArrayType", xmlRequired: false}},
            ID: "AttributeRecommendationsType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {AttributeSet: {name: "AttributeSet", type: "AttributeSetType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {BestOffer: {name: "BestOffer", type: "BestOfferType", xmlRequired: false}},
            ...
            inheritsFrom: "string",
            name: "BestOfferIDType"
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "BestOfferStatusCodeType",
            valueMap: ["Pending", "Accepted", "Declined", "Expired", "Retracted", "AdminEnded", "Active", "Countered", "All", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["Unknown", "Bid", "NotUsed", "Retraction", "AutoRetraction", "Cancelled", "AutoCancel", "Absentee", "BuyItNow", "Purchase", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {LiveAuctionBid: {name: "LiveAuctionBid", type: "BidApprovalType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {BidGroup: {name: "BidGroup", type: "BidGroupType", xmlRequired: false}},
            ID: "BidGroupArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "BidGroupItemStatusCodeType",
            valueMap: ["CurrentBid", "Cancelled", "Pending", "Skipped", "Ended", "Won", "GroupClosed", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            mustQualify: true,
            fields: {BidderDetail: {name: "BidderDetail", type: "BidderDetailType", xmlRequired: false}},
            ...
            fields: {
                UnsuccessfulBidderNoticeIncludeMyItems: {
                    name: "UnsuccessfulBidderNoticeIncludeMyItems",
                    type: "boolean",
                    xmlRequired: false
                }
            },
            ...
            valueMap: ["ItemIneligible", "ItemEligible", "ItemMarkedIneligible", "ItemMarkedEligible", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {
                ShipToRegistrationCountry: {
                    name: "ShipToRegistrationCountry",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {ShippingAddress: {name: "ShippingAddress", type: "AddressType", xmlRequired: false}},
            ID: "BuyerType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            ...
            fields: {
                CalculatedShippingAmountForEntireOrder: {
                    name: "CalculatedShippingAmountForEntireOrder",
                    type: "AmountType",
                    xmlRequired: false
                },
                CalculatedShippingChargeOption: {
                    name: "CalculatedShippingChargeOption",
                    type: "CalculatedShippingChargeOptionCodeType",
                    xmlRequired: false
                },
                CalculatedShippingRateOption: {
                    name: "CalculatedShippingRateOption",
            ...
            fields: {
                ...
                InternationalPackagingHandlingCosts: {
                    name: "InternationalPackagingHandlingCosts",
                    type: "AmountType",
                    xmlRequired: false
                }
            },
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {CancelOffer: {name: "CancelOffer", type: "CancelOfferType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {CartItem: {name: "CartItem", type: "CartItemType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {Category: {name: "Category", type: "CategoryType", xmlRequired: false}},
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                LocalMarketSpecialitySubscription: {
                    name: "LocalMarketSpecialitySubscription",
                    type: "boolean",
                    xmlRequired: false
                },
                LocalMarketRegularSubscription: {
                    name: "LocalMarketRegularSubscription",
                    type: "boolean",
                    xmlRequired: false
                },
                LocalMarketPremiumSubscription: {
                    name: "LocalMarketPremiumSubscription",
                    type: "boolean",
                    xmlRequired: false
                },
                ...
                TransactionConfirmationRequestEnabled: {
                    name: "TransactionConfirmationRequestEnabled",
                    type: "boolean",
                    xmlRequired: false
                },
                ...
                SkypeMeNonTransactionalEnabled: {
                    name: "SkypeMeNonTransactionalEnabled",
                    type: "boolean",
                    xmlRequired: false
                },
                ClassifiedAdPaymentMethodEnabled: {
                    name: "ClassifiedAdPaymentMethodEnabled",
                    type: "ClassifiedAdPaymentMethodEnabledCodeType",
                    xmlRequired: false
                },
                ClassifiedAdShippingMethodEnabled: {
                    name: "ClassifiedAdShippingMethodEnabled",
                    type: "boolean",
                    xmlRequired: false
                },
                ClassifiedAdBestOfferEnabled: {
                    name: "ClassifiedAdBestOfferEnabled",
                ...
                ClassifiedAdContactByPhoneEnabled: {
                    name: "ClassifiedAdContactByPhoneEnabled",
                    type: "boolean",
                    xmlRequired: false
                },
                ClassifiedAdContactByEmailEnabled: {
                    name: "ClassifiedAdContactByEmailEnabled",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            valueMap: ["NoFilter", "ItemsBy24Hr", "ItemsEndToday", "ItemsEndIn5Hr", "SortByPriceAsc", "SortByPriceDesc", "BestMatchSort", "DistanceSort", "CustomCode", "BestMatchCategoryGroup"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true,
            fields: {ID: {name: "ID", type: "string", xmlRequired: false}},
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {HistogramEntry: {name: "HistogramEntry", type: "HistogramEntryType", xmlRequired: false}},
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {CharityID: {name: "CharityID", type: "CharityIDType", xmlRequired: false}},
            ...
            valueMap: ["Suspended", "Registered", "Closed", "CreditCardExpired", "TokenExpired", "CreditCardAboutToExpire", "RegisteredNoCreditCard", "NotRegisteredLostDirectSellerStatus", "DirectDebitRejected", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
                CharitySellerStatus: {
                    name: "CharitySellerStatus",
            ...
            valueMap: ["CheckoutComplete", "CheckoutIncomplete", "BuyerRequestsTotal", "SellerResponded", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["CountryDetails", "CurrencyDetails", "PaymentOptionDetails", "RegionDetails", "ShippingLocationDetails", "ShippingServiceDetails", "SiteDetails", "TaxJurisdiction", "URLDetails", "TimeZoneDetails", "CustomCode", "DispatchTimeMaxDetails"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["EachAdditionalAmount", "EachAdditionalAmountOff", "EachAdditionalPercentOff", "IndividualItemWeight", "CombinedItemWeight", "WeightOff", "ShippingCostXForAmountY", "ShippingCostXForItemCountN", "MaximumShippingCostPerOrder", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {Department: {name: "Department", type: "ExpressHistogramDepartmentType", xmlRequired: false}},
            ...
            valueMap: ["LostOrBroken", "NotAvailable", "Incorrect", "OtherListingError", "CustomCode", "SellToHighBidder"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "EscrowCodeType",
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                FeedbackAsSellerScore: {
                    name: "FeedbackAsSellerScore",
                    type: "FeedbackRequirementsType",
                    xmlRequired: false
                },
                PositiveFeedbackAsSellerPercent: {
                    name: "PositiveFeedbackAsSellerPercent",
                    type: "FeedbackRequirementsType",
                    xmlRequired: false
                },
            ...
            mustQualify: true,
            fields: {ExternalAlertID: {name: "ExternalAlertID", type: "string", xmlRequired: false}},
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                LocalMarketNonSubscription: {
                    name: "LocalMarketNonSubscription",
            ...
            mustQualify: true,
            fields: {FeedbackDetail: {name: "FeedbackDetail", type: "FeedbackDetailType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {FeedbackPeriod: {name: "FeedbackPeriod", type: "FeedbackPeriodType", xmlRequired: false}},
            ...
            valueMap: ["ItemAsDescribed", "Communication", "ShippingTime", "ShippingAndHandlingCharges", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "FeedbackRatingStarCodeType",
            valueMap: ["None", "Yellow", "Blue", "Turquoise", "Purple", "Red", "Green", "YellowShooting", "TurquoiseShooting", "PurpleShooting", "RedShooting", "CustomCode"]
        }), isc.XSComplexType.create({
            textContentProperty: "xmlTextContent",
            mustQualify: true,
            fields: {
            ...
            fields: {
                BidRetractionFeedbackPeriodArray: {
                    name: "BidRetractionFeedbackPeriodArray",
                    type: "FeedbackPeriodArrayType",
                    xmlRequired: false
                },
                NegativeFeedbackPeriodArray: {
                    name: "NegativeFeedbackPeriodArray",
                    type: "FeedbackPeriodArrayType",
                    xmlRequired: false
                },
                NeutralFeedbackPeriodArray: {
                    name: "NeutralFeedbackPeriodArray",
                    type: "FeedbackPeriodArrayType",
                    xmlRequired: false
                },
                PositiveFeedbackPeriodArray: {
                    name: "PositiveFeedbackPeriodArray",
                    type: "FeedbackPeriodArrayType",
                    xmlRequired: false
                },
                TotalFeedbackPeriodArray: {
                    name: "TotalFeedbackPeriodArray",
                    type: "FeedbackPeriodArrayType",
                    xmlRequired: false
                },
                ...
                SellerAverageRatingDetailArray: {
                    name: "SellerAverageRatingDetailArray",
            ...
            mustQualify: true,
            fields: {Fee: {name: "Fee", type: "FeeType", xmlRequired: false}},
            ID: "FeesType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {FinanceOffer: {name: "FinanceOffer", type: "FinanceOfferType", xmlRequired: false}},
            ...
            valueMap: ["FlatRateInsuranceRange1", "FlatRateInsuranceRange2", "FlatRateInsuranceRange3", "FlatRateInsuranceRange4", "FlatRateInsuranceRange5", "FlatRateInsuranceRange6", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
                FlatRateInsuranceRange: {
                    name: "FlatRateInsuranceRange",
            ...
            fields: {
                ...
                DeductionAmountPerAdditionalItem: {
                    name: "DeductionAmountPerAdditionalItem",
                    type: "AmountType",
                    xmlRequired: false
                },
                FlatRateInsuranceRangeCost: {
                    name: "FlatRateInsuranceRangeCost",
                    type: "FlatRateInsuranceRangeCostType",
                    xmlRequired: false
                },
                FlatShippingRateOption: {
                    name: "FlatShippingRateOption",
            ...
            valueMap: ["ChargeAmountForEachAdditionalItem", "DeductAmountFromEachAdditionalItem", "ShipAdditionalItemsFree", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "GallerySortFilterCodeType",
            valueMap: ["ShowAnyItems", "ShowItemsWithGalleryImagesFirst", "ShowOnlyItemsWithGalleryImages", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["EachAdditionalAmount", "EachAdditionalAmountOff", "EachAdditionalPercentOff", "IndividualHandlingFee", "CombinedHandlingFee", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["NoHitCounter", "HonestyStyle", "GreenLED", "Hidden", "BasicStyle", "RetroStyle", "HiddenStyle", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {},
            ...
            valueMap: ["Optional", "Required", "NotOffered", "IncludedInShippingHandling", "NotOfferedOnSite", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "InsuranceSelectedCodeType",
            valueMap: ["NotOffered", "OfferedNotSelected", "OfferedSelected", "Required", "IncludedInShippingHandling", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["ShowAnyItems", "ShowItemsWithBINFirst", "ShowOnlyItemsWithBIN", "ShowOnlyStoreItems", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {ItemID: {name: "ItemID", type: "ItemIDType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {ItemRatingDetails: {name: "ItemRatingDetails", type: "ItemRatingDetailsType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {ItemTransactionID: {name: "ItemTransactionID", type: "ItemTransactionIDType", xmlRequired: false}},
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                CategoryBasedAttributesPrefill: {
                    name: "CategoryBasedAttributesPrefill",
                    type: "boolean",
                    xmlRequired: false
                },
                ...
                ListingCheckoutRedirectPreference: {
                    name: "ListingCheckoutRedirectPreference",
                ...
                ExtendedSellerContactDetails: {
                    name: "ExtendedSellerContactDetails",
            ...
            valueMap: ["AuctionItemsOnly", "FixedPricedItem", "AllItems", "StoreInventoryOnly", "FixedPriceExcludeStoreInventory", "ExcludeStoreInventory", "AllItemTypes", "AllFixedPriceItemTypes", "CustomCode", "ClassifiedItemsOnly"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {ListingTipArray: {name: "ListingTipArray", type: "ListingTipArrayType", xmlRequired: false}},
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                SecondChanceOriginalItemID: {
                    name: "SecondChanceOriginalItemID",
                    type: "ItemIDType",
                    xmlRequired: false
                },
                StartTime: {name: "StartTime", type: "dateTime", xmlRequired: false},
            ...
            valueMap: ["Days_1", "Days_3", "Days_5", "Days_7", "Days_10", "Days_14", "Days_21", "Days_30", "Days_60", "Days_90", "Days_120", "GTC", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["Border", "BoldTitle", "Featured", "Highlight", "HomePageFeatured", "ProPackBundle", "BasicUpgradePackBundle", "ValuePackBundle", "ProPackPlusBundle", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true,
            fields: {ListingTip: {name: "ListingTip", type: "ListingTipType", xmlRequired: false}},
            ...
            valueMap: ["Unknown", "Chinese", "Dutch", "Live", "Auction", "AdType", "StoresFixedPrice", "PersonalOffer", "FixedPriceItem", "Half", "LeadGeneration", "Express", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {
                LiveAuctionStatus: {
                    name: "LiveAuctionStatus",
            ...
            mustQualify: true,
            fields: {LiveAuctionBid: {name: "LiveAuctionBid", type: "LiveAuctionBidType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {LookupAttribute: {name: "LookupAttribute", type: "LookupAttributeType", xmlRequired: false}},
            ...
            valueMap: ["AskSellerQuestion", "ResponseToASQQuestion", "ContactEbayMember", "ContactTransactionPartner", "ResponseToContacteBayMember", "ContacteBayMemberViaCommunityLink", "CustomCode", "All", "ContactMyBidder"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {},
            ...
            mustQualify: true,
            fields: {Alert: {name: "Alert", type: "MyMessagesAlertType", xmlRequired: false}},
            ID: "MyMessagesAlertArrayType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {AlertID: {name: "AlertID", type: "MyMessagesAlertIDType", xmlRequired: false}},
            ID: "MyMessagesAlertIDArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "string",
            name: "MyMessagesAlertIDType"
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true,
            fields: {Message: {name: "Message", type: "MyMessagesMessageType", xmlRequired: false}},
            ID: "MyMessagesMessageArrayType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {MessageID: {name: "MessageID", type: "MyMessagesMessageIDType", xmlRequired: false}},
            ID: "MyMessagesMessageIDArrayType"
        }), isc.SimpleType.create({inheritsFrom: "string", name: "MyMessagesMessageIDType"}), isc.XSComplexType.create({
            mustQualify: true, xsdAnyElement: true, fields: {
                Sender: {name: "Sender", type: "string", xmlRequired: false},
                RecipientUserID: {name: "RecipientUserID", type: "string", xmlRequired: false},
            ...
            mustQualify: true,
            fields: {NameValueList: {name: "NameValueList", type: "NameValueListType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {Offer: {name: "Offer", type: "OfferType", xmlRequired: false}},
            ID: "OfferArrayType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            ...
            mustQualify: true,
            fields: {OrderID: {name: "OrderID", type: "OrderIDType", xmlRequired: false}},
            ID: "OrderIDArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "string",
            name: "OrderIDType"
            ...
            valueMap: ["Active", "Inactive", "Completed", "Cancelled", "Shipped", "Default", "Authenticated", "InProcess", "Invalid", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {OrderTransaction: {name: "OrderTransaction", type: "OrderTransactionType", xmlRequired: false}},
            ...
            valueMap: ["NotPaid", "BuyerHasNotCompletedCheckout", "PaymentPendingWithPayPal", "PaidWithPayPal", "MarkedAsPaid", "PaymentPendingWithEscrow", "PaidWithEscrow", "EscrowPaymentCancelled", "PaymentPendingWithPaisaPay", "PaidWithPaisaPay", "PaymentPending", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "PayPalAccountLevelCodeType",
            valueMap: ["Unverified", "InternationalUnverified", "Verified", "InternationalVerified", "Trusted", "Unknown", "Invalid", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "PayPalAccountStatusCodeType",
            valueMap: ["Active", "Closed", "HighRestricted", "LowRestricted", "Locked", "CustomCode", "WireOff", "Unknown", "Invalid"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["NoPaymentFailure", "BuyerECheckBounced", "BuyerCreditCardFailed", "BuyerFailedPaymentReportedBySeller", "PayPalPaymentInProcess", "PaymentInProcess", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["None", "SlideShow", "SuperSize", "PicturePack", "SiteHostedPictureShow", "VendorHostedPictureShow", "SuperSizePictureShow", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            fields: {
                ...
                Name: {name: "Name", type: "string", xmlRequired: false},
                Date: {name: "Date", type: "dateTime", xmlRequired: false},
                DisplayFormat: {name: "DisplayFormat", type: "PictureManagerPictureDisplayType", xmlRequired: false}
            },
            ...
            mustQualify: true,
            fields: {ProductInfo: {name: "ProductInfo", type: "ProductInfoType", xmlRequired: false}},
            ...
            fields: {
                CheckoutRedirectProStores: {
                    name: "CheckoutRedirectProStores",
                    type: "boolean",
                    xmlRequired: false
                },
                ProStoresDetails: {
                    name: "ProStoresDetails",
            ...
            mustQualify: true,
            fields: {Product: {name: "Product", type: "ExpressProductType", xmlRequired: false}},
            ID: "ProductArrayType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            ...
            fields: {
                ...
                IncludePrefilledItemInformation: {
                    name: "IncludePrefilledItemInformation",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            mustQualify: true,
            fields: {Product: {name: "Product", type: "ProductInfoType", xmlRequired: false}},
            ...
            valueMap: ["PopularityAsc", "PopularityDesc", "RatingAsc", "RatingDesc", "ReviewCountAsc", "ReviewCountDesc", "ItemCountAsc", "ItemCountDesc", "TitleAsc", "TitleDesc", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["AuctionPrice", "BuyItNowPrice", "BestOfferOnlyPrice", "ClassifiedAdPrice", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true,
            fields: {PromotionRule: {name: "PromotionRule", type: "PromotionRuleType", xmlRequired: false}},
            ...
            valueMap: ["ItemToItem", "ItemToStoreCat", "StoreToStoreCat", "ItemToDefaultRule", "DefaultRule", "CategoryProximity", "RelatedCategoryRule", "DefaultUpSellLogic", "DefaultCrossSellLogic", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {PromotionalSale: {name: "PromotionalSale", type: "PromotionalSaleType", xmlRequired: false}},
            ...
            valueMap: ["Other", "BuyNowItem", "ShoppingCart", "AuctionItem", "GiftCertificates", "Subscription", "Donation", "eBayBilling", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "QuantityOperatorCodeType",
            valueMap: ["LessThan", "LessThanOrEqual", "Equal", "GreaterThan", "GreaterThanOrEqual", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "QuestionTypeCodeType",
            valueMap: ["General", "Shipping", "Payment", "MultipleItemShipping", "CustomizedSubject", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true,
            fields: {Refund: {name: "Refund", type: "RefundType", xmlRequired: false}},
            ID: "RefundArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "RefundReasonCodeType",
            valueMap: ["CannotShipProduct", "WrongItemShipped", "ItemBadQuality", "ItemDamaged", "BuyerRemorse", "Other", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            mustQualify: true,
            fields: {Keyword: {name: "Keyword", type: "string", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {SKU: {name: "SKU", type: "SKUType", xmlRequired: false}},
            ID: "SKUArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "string",
            name: "SKUType"
            ...
            valueMap: ["SMSAggregatorNotAvailable", "PhoneNumberInvalid", "PhoneNumberChanged", "PhoneNumberCarrierChanged", "UserRequestedUnregistration", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["Charity", "SearchInDescription", "PayPalBuyerPaymentOption", "NowAndNew", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            mustQualify: true,
            fields: {SearchResultItem: {name: "SearchResultItem", type: "SearchResultItemType", xmlRequired: false}},
            ...
            valueMap: ["SortByEndDate", "SortByStartDate", "SortByCurrentBid", "SortByListingDate", "SortByCurrentBidAsc", "SortByCurrentBidDesc", "SortByPayPalAsc", "SortByPayPalDesc", "SortByEscrowAsc", "SortByEscrowDesc", "SortByCountryAsc", "SortByCountryDesc", "SortByDistanceAsc", "SortByBidCountAsc", "SortByBidCountDesc", "BestMatchSort", "CustomCode", "BestMatchCategoryGroup"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            fields: {
                ...
                StoreCategoryID: {name: "StoreCategoryID", type: "long", xmlRequired: false},
                ListingType: {name: "ListingType", type: "ListingTypeCodeType", xmlRequired: false},
                SearchSortOrder: {name: "SearchSortOrder", type: "StoreItemListSortOrderCodeType", xmlRequired: false},
                MinPrice: {name: "MinPrice", type: "AmountType", xmlRequired: false},
                MaxPrice: {name: "MaxPrice", type: "AmountType", xmlRequired: false},
            ...
            valueMap: ["NothingOnFile", "CreditCard", "DirectDebit", "DirectDebitPendingSignatureMandate", "eBayDirectPay", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
                AlwaysUseThisPaymentAddress: {
                    name: "AlwaysUseThisPaymentAddress",
                    type: "boolean",
                    xmlRequired: false
                },
                DisplayPayNowButton: {
                    name: "DisplayPayNowButton",
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                ExpressSellerRequirements: {
                    name: "ExpressSellerRequirements",
            ...
            valueMap: ["Created", "DroppedOff", "InTransit", "Delivered", "Returned", "Canceled", "LabelPrinted", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                SellingManagerSalesRecordNumber: {
                    name: "SellingManagerSalesRecordNumber",
                    type: "int",
                    xmlRequired: false
                },
                ThirdPartyCheckout: {name: "ThirdPartyCheckout", type: "boolean", xmlRequired: false},
                ...
                InternationalShippingDiscountProfileID: {
                    name: "InternationalShippingDiscountProfileID",
                    type: "string",
                    xmlRequired: false
                },
                InternationalFlatShippingDiscount: {
                    name: "InternationalFlatShippingDiscount",
                    type: "FlatShippingDiscountType",
                    xmlRequired: false
                },
                InternationalCalculatedShippingDiscount: {
                    name: "InternationalCalculatedShippingDiscount",
                    type: "CalculatedShippingDiscountType",
                    xmlRequired: false
                },
                InternationalPromotionalShippingDiscount: {
                    name: "InternationalPromotionalShippingDiscount",
                    type: "boolean",
                    xmlRequired: false
                },
                PromotionalShippingDiscountDetails: {
            ...
            valueMap: ["DeliveryConfirmation", "SignatureConfirmation", "StealthPostage", "SaturdayDelivery", "Other", "NotDefined", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
            ...
            valueMap: ["None", "Letter", "LargeEnvelope", "USPSLargePack", "VeryLargePack", "ExtraLargePack", "UPSLetter", "USPSFlatRateEnvelope", "PackageThickEnvelope", "Roll", "Europallet", "OneWayPallet", "BulkyGoods", "Furniture", "Cars", "Motorbikes", "Caravan", "IndustryVehicles", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            ...
            valueMap: ["Flat", "Calculated", "Freight", "Free", "NotSpecified", "FlatDomesticCalculatedInternational", "CalculatedDomesticFlatInternational", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "SiteCodeType",
            valueMap: ["US", "Canada", "UK", "Australia", "Austria", "Belgium_French", "France", "Germany", "Italy", "Belgium_Dutch", "Netherlands", "Spain", "Switzerland", "Taiwan", "eBayMotors", "HongKong", "Singapore", "India", "China", "Ireland", "Malaysia", "Philippines", "Poland", "Sweden", "CustomCode", "CanadaFrench"]
        }), isc.XSComplexType.create({
            mustQualify: true, xsdAnyElement: true, fields: {
                ListingDuration: {name: "ListingDuration", type: "ListingDurationReferenceType", xmlRequired: false},
                ShippingTermsRequired: {name: "ShippingTermsRequired", type: "boolean", xmlRequired: false},
            ...
            valueMap: ["ListedInCurrencyImplied", "LocatedInCountryImplied", "AvailableInCountryImplied", "SiteImplied", "BelgiumListing", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {SiteID: {name: "SiteID", type: "SiteIDFilterCodeType", xmlRequired: false}},
            ID: "SiteLocationType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            ...
            mustQualify: true,
            fields: {ColorScheme: {name: "ColorScheme", type: "StoreColorSchemeType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {CustomCategory: {name: "CustomCategory", type: "StoreCustomCategoryType", xmlRequired: false}},
            ...
            fields: {
                ...
                LinkToInclude: {name: "LinkToInclude", type: "StoreCustomListingHeaderLinkType", xmlRequired: false},
            ...
            mustQualify: true,
            fields: {Logo: {name: "Logo", type: "StoreLogoType", xmlRequired: false}},
            ...
            valueMap: ["AllItemsInTheStore", "AuctionItemsInTheStore", "BuyItNowItemsInTheStore", "BuyItNowItemsInAllStores", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {Subscription: {name: "Subscription", type: "StoreSubscriptionType", xmlRequired: false}},
            ...
            fields: {
                ...
                DisplayMessageStoreCustomText: {
                    name: "DisplayMessageStoreCustomText",
                    type: "boolean",
                    xmlRequired: false
                },
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {SuggestedCategory: {name: "SuggestedCategory", type: "SuggestedCategoryType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {TaxJurisdiction: {name: "TaxJurisdiction", type: "TaxJurisdictionType", xmlRequired: false}},
            ID: "TaxTableType"
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            ...
            mustQualify: true,
            fields: {Transaction: {name: "Transaction", type: "TransactionType", xmlRequired: false}},
            ...
            mustQualify: true, xsdAnyElement: true, fields: {
                ...
                SellingManagerProductDetails: {
                    name: "SellingManagerProductDetails",
            ...
            valueMap: ["ViewItemURL", "ViewUserURL", "MyeBayURL", "MyeBayBiddingURL", "MyeBayNotWonURL", "MyeBayWonURL", "MyeBayWatchingURL", "eBayStoreURL", "SmallLogoURL", "MediumLogoURL", "LargeLogoURL", "CustomCode"]
        }), isc.SimpleType.create({
            inheritsFrom: "token",
            name: "UnitCodeType",
            ...
            mustQualify: true,
            xsdAnyElement: true,
            fields: {UserID: {name: "UserID", type: "UserIDType", xmlRequired: false}},
            ID: "UserIDArrayType"
        }), isc.SimpleType.create({
            inheritsFrom: "string",
            name: "UserIDType"
            ...
            valueMap: ["Unknown", "Suspended", "Confirmed", "Unconfirmed", "Ghost", "InMaintenance", "Deleted", "CreditCardVerify", "AccountOnHold", "Merged", "RegistrationCodeMailOut", "TermPending", "UnconfirmedHalfOptIn", "CreditCardVerifyHalfOptIn", "UnconfirmedPassport", "CreditCardVerifyPassport", "UnconfirmedExpress", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true, xsdAnyElement: true, fields: {
            ...
            valueMap: ["Received", "Submitted", "Removed", "SubmissionFailed", "ClarificationRequired", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            fields: {VeROSiteDetail: {name: "VeROSiteDetail", type: "VeROSiteDetailType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {ReportItem: {name: "ReportItem", type: "VeROReportItemType", xmlRequired: false}},
            ...
            mustQualify: true,
            fields: {ReportedItem: {name: "ReportedItem", type: "VeROReportedItemType", xmlRequired: false}},
            ...
            valueMap: ["Cingular", "TMobile", "Sprint", "Nextel", "Verizon", "CincinnatiBell", "Dobson", "Alltel", "Leap", "USCellular", "Movistar", "Amena", "Vodafone", "ATT", "CustomCode"]
        }), isc.XSComplexType.create({
            mustQualify: true,
            xsdAnyElement: true,
            fields: {
    ...
    isc.WebService.create({
        ...
        operations: [{
            ...
            inputHeaders: [{encoding: "literal", part: "RequesterCredentials", message: "RequesterCredentials"}],
            outputHeaders: [{encoding: "literal", part: "RequesterCredentials", message: "RequesterCredentials"}],
        ...
        messages: [isc.WSDLMessage.create({
            fields: {
                RequesterCredentials: {
                    name: "RequesterCredentials",
            ...
            fields: {
                AddDisputeRequest: {
                    name: "AddDisputeRequest",
                    type: "AddDisputeRequest",
                    xmlRequired: true
                }
            }, ID: "message:AddDisputeRequest"
        }), isc.WSDLMessage.create({
            fields: {
                AddDisputeResponseResponse: {
                    name: "AddDisputeResponseResponse",
                    type: "AddDisputeResponseResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddDisputeResponseRequest: {
                    name: "AddDisputeResponseRequest",
                    type: "AddDisputeResponseRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                AddLiveAuctionItemResponse: {
                    name: "AddLiveAuctionItemResponse",
                    type: "AddLiveAuctionItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddLiveAuctionItemRequest: {
                    name: "AddLiveAuctionItemRequest",
                    type: "AddLiveAuctionItemRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                AddMemberMessageAAQToPartnerResponse: {
                    name: "AddMemberMessageAAQToPartnerResponse",
            ...
            fields: {
                AddMemberMessageRTQResponse: {
                    name: "AddMemberMessageRTQResponse",
            ...
            fields: {
                AddMemberMessageRTQRequest: {
                    name: "AddMemberMessageRTQRequest",
            ...
            fields: {
                AddMemberMessagesAAQToBidderResponse: {
                    name: "AddMemberMessagesAAQToBidderResponse",
                    type: "AddMemberMessagesAAQToBidderResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddMemberMessagesAAQToBidderRequest: {
                    name: "AddMemberMessagesAAQToBidderRequest",
                    type: "AddMemberMessagesAAQToBidderRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                AddSecondChanceItemResponse: {
                    name: "AddSecondChanceItemResponse",
                    type: "AddSecondChanceItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddSecondChanceItemRequest: {
                    name: "AddSecondChanceItemRequest",
                    type: "AddSecondChanceItemRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                AddToItemDescriptionResponse: {
                    name: "AddToItemDescriptionResponse",
                    type: "AddToItemDescriptionResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddToItemDescriptionRequest: {
                    name: "AddToItemDescriptionRequest",
                    type: "AddToItemDescriptionRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                AddTransactionConfirmationItemResponse: {
                    ...
                    type: "AddTransactionConfirmationItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                AddTransactionConfirmationItemRequest: {
                    name: "AddTransactionConfirmationItemRequest",
                    type: "AddTransactionConfirmationItemRequest",
                    xmlRequired: true
                }
            }, ID: "message:AddTransactionConfirmationItemRequest"
        }), isc.WSDLMessage.create({
            fields: {
                ApproveLiveAuctionBiddersResponse: {
                    name: "ApproveLiveAuctionBiddersResponse",
                    type: "ApproveLiveAuctionBiddersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ApproveLiveAuctionBiddersRequest: {
                    name: "ApproveLiveAuctionBiddersRequest",
                    type: "ApproveLiveAuctionBiddersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                DeleteMyMessagesResponse: {
                    name: "DeleteMyMessagesResponse",
                    type: "DeleteMyMessagesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                DeleteMyMessagesRequest: {
                    name: "DeleteMyMessagesRequest",
                    type: "DeleteMyMessagesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAdFormatLeadsResponse: {
                    name: "GetAdFormatLeadsResponse",
                    type: "GetAdFormatLeadsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAdFormatLeadsRequest: {
                    name: "GetAdFormatLeadsRequest",
                    type: "GetAdFormatLeadsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAllBiddersResponse: {
                    name: "GetAllBiddersResponse",
                    type: "GetAllBiddersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAllBiddersRequest: {
                    name: "GetAllBiddersRequest",
                    type: "GetAllBiddersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetApiAccessRulesResponse: {
                    name: "GetApiAccessRulesResponse",
                    type: "GetApiAccessRulesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetApiAccessRulesRequest: {
                    name: "GetApiAccessRulesRequest",
                    type: "GetApiAccessRulesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAttributesCSResponse: {
                    name: "GetAttributesCSResponse",
                    type: "GetAttributesCSResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAttributesCSRequest: {
                    name: "GetAttributesCSRequest",
                    type: "GetAttributesCSRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAttributesXSLResponse: {
                    name: "GetAttributesXSLResponse",
                    type: "GetAttributesXSLResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetAttributesXSLRequest: {
                    name: "GetAttributesXSLRequest",
                    type: "GetAttributesXSLRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetBestOffersResponse: {
                    name: "GetBestOffersResponse",
                    type: "GetBestOffersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetBestOffersRequest: {
                    name: "GetBestOffersRequest",
                    type: "GetBestOffersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetBidderListResponse: {
                    name: "GetBidderListResponse",
                    type: "GetBidderListResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetBidderListRequest: {
                    name: "GetBidderListRequest",
                    type: "GetBidderListRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategory2CSResponse: {
                    name: "GetCategory2CSResponse",
                    type: "GetCategory2CSResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategory2CSRequest: {
                    name: "GetCategory2CSRequest",
                    type: "GetCategory2CSRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetCategory2CSRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetCategory2FinanceOfferResponse: {
                    name: "GetCategory2FinanceOfferResponse",
                    type: "GetCategory2FinanceOfferResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategory2FinanceOfferRequest: {
                    name: "GetCategory2FinanceOfferRequest",
                    type: "GetCategory2FinanceOfferRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryFeaturesResponse: {
                    name: "GetCategoryFeaturesResponse",
                    type: "GetCategoryFeaturesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryFeaturesRequest: {
                    name: "GetCategoryFeaturesRequest",
                    type: "GetCategoryFeaturesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryListingsResponse: {
                    name: "GetCategoryListingsResponse",
                    type: "GetCategoryListingsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryListingsRequest: {
                    name: "GetCategoryListingsRequest",
                    type: "GetCategoryListingsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryMappingsResponse: {
                    name: "GetCategoryMappingsResponse",
                    type: "GetCategoryMappingsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCategoryMappingsRequest: {
                    name: "GetCategoryMappingsRequest",
                    type: "GetCategoryMappingsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetChallengeTokenResponse: {
                    name: "GetChallengeTokenResponse",
                    type: "GetChallengeTokenResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetChallengeTokenRequest: {
                    name: "GetChallengeTokenRequest",
                    type: "GetChallengeTokenRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCharitiesResponse: {
                    name: "GetCharitiesResponse",
                    type: "GetCharitiesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCharitiesRequest: {
                    name: "GetCharitiesRequest",
                    type: "GetCharitiesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetContextualKeywordsResponse: {
                    name: "GetContextualKeywordsResponse",
                    type: "GetContextualKeywordsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetContextualKeywordsRequest: {
                    name: "GetContextualKeywordsRequest",
                    type: "GetContextualKeywordsRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetContextualKeywordsRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetCrossPromotionsResponse: {
                    name: "GetCrossPromotionsResponse",
                    type: "GetCrossPromotionsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetCrossPromotionsRequest: {
                    name: "GetCrossPromotionsRequest",
                    type: "GetCrossPromotionsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetDescriptionTemplatesResponse: {
                    name: "GetDescriptionTemplatesResponse",
                    type: "GetDescriptionTemplatesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetDescriptionTemplatesRequest: {
                    name: "GetDescriptionTemplatesRequest",
                    type: "GetDescriptionTemplatesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetFinanceOffersResponse: {
                    name: "GetFinanceOffersResponse",
                    type: "GetFinanceOffersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetFinanceOffersRequest: {
                    name: "GetFinanceOffersRequest",
                    type: "GetFinanceOffersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetHighBiddersResponse: {
                    name: "GetHighBiddersResponse",
                    type: "GetHighBiddersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetHighBiddersRequest: {
                    name: "GetHighBiddersRequest",
                    type: "GetHighBiddersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemRecommendationsResponse: {
                    name: "GetItemRecommendationsResponse",
                    type: "GetItemRecommendationsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemRecommendationsRequest: {
                    name: "GetItemRecommendationsRequest",
                    type: "GetItemRecommendationsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemShippingResponse: {
                    name: "GetItemShippingResponse",
                    type: "GetItemShippingResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemShippingRequest: {
                    name: "GetItemShippingRequest",
                    type: "GetItemShippingRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemTransactionsResponse: {
                    name: "GetItemTransactionsResponse",
                    type: "GetItemTransactionsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemTransactionsRequest: {
                    name: "GetItemTransactionsRequest",
                    type: "GetItemTransactionsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemsAwaitingFeedbackResponse: {
                    name: "GetItemsAwaitingFeedbackResponse",
                    type: "GetItemsAwaitingFeedbackResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetItemsAwaitingFeedbackRequest: {
                    name: "GetItemsAwaitingFeedbackRequest",
                    type: "GetItemsAwaitingFeedbackRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetItemsAwaitingFeedbackRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetLiveAuctionBiddersResponse: {
                    name: "GetLiveAuctionBiddersResponse",
                    type: "GetLiveAuctionBiddersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetLiveAuctionBiddersRequest: {
                    name: "GetLiveAuctionBiddersRequest",
                    type: "GetLiveAuctionBiddersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetLiveAuctionCatalogDetailsResponse: {
                    name: "GetLiveAuctionCatalogDetailsResponse",
                    type: "GetLiveAuctionCatalogDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetLiveAuctionCatalogDetailsRequest: {
                    name: "GetLiveAuctionCatalogDetailsRequest",
                    type: "GetLiveAuctionCatalogDetailsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMemberMessagesResponse: {
                    name: "GetMemberMessagesResponse",
                    type: "GetMemberMessagesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMessagePreferencesResponse: {
                    name: "GetMessagePreferencesResponse",
                    type: "GetMessagePreferencesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMyMessagesResponse: {
                    name: "GetMyMessagesResponse",
                    type: "GetMyMessagesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMyMessagesRequest: {
                    name: "GetMyMessagesRequest",
                    type: "GetMyMessagesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMyeBayBuyingRequest: {
                    name: "GetMyeBayBuyingRequest",
                    type: "GetMyeBayBuyingRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMyeBayRemindersResponse: {
                    name: "GetMyeBayRemindersResponse",
                    type: "GetMyeBayRemindersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetMyeBaySellingRequest: {
                    name: "GetMyeBaySellingRequest",
                    type: "GetMyeBaySellingRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetNotificationPreferencesResponse: {
                    name: "GetNotificationPreferencesResponse",
            ...
            fields: {
                GetNotificationPreferencesRequest: {
                    name: "GetNotificationPreferencesRequest",
            ...
            fields: {
                GetNotificationsUsageResponse: {
                    name: "GetNotificationsUsageResponse",
                    type: "GetNotificationsUsageResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetNotificationsUsageRequest: {
                    name: "GetNotificationsUsageRequest",
                    type: "GetNotificationsUsageRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetOrderTransactionsResponse: {
                    name: "GetOrderTransactionsResponse",
            ...
            fields: {
                GetOrderTransactionsRequest: {
                    name: "GetOrderTransactionsRequest",
            ...
            fields: {
                GetPictureManagerDetailsResponse: {
                    name: "GetPictureManagerDetailsResponse",
                    type: "GetPictureManagerDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPictureManagerDetailsRequest: {
                    name: "GetPictureManagerDetailsRequest",
                    type: "GetPictureManagerDetailsRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetPictureManagerDetailsRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetPictureManagerOptionsResponse: {
                    name: "GetPictureManagerOptionsResponse",
                    type: "GetPictureManagerOptionsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPictureManagerOptionsRequest: {
                    name: "GetPictureManagerOptionsRequest",
            ...
            fields: {
                GetPopularKeywordsResponse: {
                    ...
                    type: "GetPopularKeywordsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPopularKeywordsRequest: {
                    name: "GetPopularKeywordsRequest",
                    type: "GetPopularKeywordsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFamilyMembersResponse: {
                    name: "GetProductFamilyMembersResponse",
                    type: "GetProductFamilyMembersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFamilyMembersRequest: {
                    name: "GetProductFamilyMembersRequest",
                    type: "GetProductFamilyMembersRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFinderResponse: {
                    name: "GetProductFinderResponse",
                    type: "GetProductFinderResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFinderRequest: {
                    name: "GetProductFinderRequest",
                    type: "GetProductFinderRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFinderXSLResponse: {
                    ...
                    type: "GetProductFinderXSLResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductFinderXSLRequest: {
                    name: "GetProductFinderXSLRequest",
                    type: "GetProductFinderXSLRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSearchPageResponse: {
                    name: "GetProductSearchPageResponse",
                    type: "GetProductSearchPageResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSearchPageRequest: {
                    name: "GetProductSearchPageRequest",
                    type: "GetProductSearchPageRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSearchResultsResponse: {
                    name: "GetProductSearchResultsResponse",
                    type: "GetProductSearchResultsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSearchResultsRequest: {
                    name: "GetProductSearchResultsRequest",
                    type: "GetProductSearchResultsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSellingPagesResponse: {
                    name: "GetProductSellingPagesResponse",
                    type: "GetProductSellingPagesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetProductSellingPagesRequest: {
                    ...
                    type: "GetProductSellingPagesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPromotionRulesResponse: {
                    name: "GetPromotionRulesResponse",
                    type: "GetPromotionRulesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPromotionRulesRequest: {
                    name: "GetPromotionRulesRequest",
                    type: "GetPromotionRulesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPromotionalSaleDetailsResponse: {
                    name: "GetPromotionalSaleDetailsResponse",
                    type: "GetPromotionalSaleDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetPromotionalSaleDetailsRequest: {
                    name: "GetPromotionalSaleDetailsRequest",
                    type: "GetPromotionalSaleDetailsRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetPromotionalSaleDetailsRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetReturnURLResponse: {
                    name: "GetReturnURLResponse",
                    type: "GetReturnURLResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetReturnURLRequest: {
                    name: "GetReturnURLRequest",
                    type: "GetReturnURLRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetRuNameResponse: {
                    name: "GetRuNameResponse",
                    type: "GetRuNameResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetRuNameRequest: {
                    name: "GetRuNameRequest",
                    type: "GetRuNameRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSearchResultsExpressResponse: {
                    name: "GetSearchResultsExpressResponse",
                    type: "GetSearchResultsExpressResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSearchResultsExpressRequest: {
                    name: "GetSearchResultsExpressRequest",
                    type: "GetSearchResultsExpressRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerEventsResponse: {
                    name: "GetSellerEventsResponse",
                    type: "GetSellerEventsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerEventsRequest: {
                    name: "GetSellerEventsRequest",
                    type: "GetSellerEventsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerListResponse: {
                    name: "GetSellerListResponse",
                    type: "GetSellerListResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerListRequest: {
                    name: "GetSellerListRequest",
                    type: "GetSellerListRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerPaymentsResponse: {
                    name: "GetSellerPaymentsResponse",
                    type: "GetSellerPaymentsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerPaymentsRequest: {
                    name: "GetSellerPaymentsRequest",
                    type: "GetSellerPaymentsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSellerTransactionsRequest: {
                    name: "GetSellerTransactionsRequest",
            ...
            fields: {
                GetShippingDiscountProfilesResponse: {
                    name: "GetShippingDiscountProfilesResponse",
                    type: "GetShippingDiscountProfilesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetShippingDiscountProfilesRequest: {
                    name: "GetShippingDiscountProfilesRequest",
                    type: "GetShippingDiscountProfilesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStoreCategoryUpdateStatusResponse: {
                    name: "GetStoreCategoryUpdateStatusResponse",
                    type: "GetStoreCategoryUpdateStatusResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStoreCategoryUpdateStatusRequest: {
                    name: "GetStoreCategoryUpdateStatusRequest",
                    type: "GetStoreCategoryUpdateStatusRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStoreCustomPageResponse: {
                    name: "GetStoreCustomPageResponse",
            ...
            fields: {
                GetStoreCustomPageRequest: {
                    name: "GetStoreCustomPageRequest",
                    type: "GetStoreCustomPageRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStoreOptionsResponse: {
                    name: "GetStoreOptionsResponse",
                    type: "GetStoreOptionsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStoreOptionsRequest: {
                    name: "GetStoreOptionsRequest",
                    type: "GetStoreOptionsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStorePreferencesResponse: {
                    name: "GetStorePreferencesResponse",
                    type: "GetStorePreferencesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetStorePreferencesRequest: {
                    name: "GetStorePreferencesRequest",
                    type: "GetStorePreferencesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSuggestedCategoriesResponse: {
                    name: "GetSuggestedCategoriesResponse",
                    type: "GetSuggestedCategoriesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetSuggestedCategoriesRequest: {
                    name: "GetSuggestedCategoriesRequest",
                    type: "GetSuggestedCategoriesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetTaxTableResponse: {
                    name: "GetTaxTableResponse",
                    type: "GetTaxTableResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetTaxTableRequest: {
                    name: "GetTaxTableRequest",
                    type: "GetTaxTableRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetUserContactDetailsResponse: {
                    name: "GetUserContactDetailsResponse",
                    type: "GetUserContactDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetUserContactDetailsRequest: {
                    name: "GetUserContactDetailsRequest",
                    type: "GetUserContactDetailsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetUserDisputesRequest: {
                    name: "GetUserDisputesRequest",
                    type: "GetUserDisputesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetUserPreferencesResponse: {
                    name: "GetUserPreferencesResponse",
            ...
            fields: {
                GetUserPreferencesRequest: {
                    name: "GetUserPreferencesRequest",
            ...
            fields: {
                GetVeROReasonCodeDetailsResponse: {
                    name: "GetVeROReasonCodeDetailsResponse",
                    type: "GetVeROReasonCodeDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetVeROReasonCodeDetailsRequest: {
                    name: "GetVeROReasonCodeDetailsRequest",
                    type: "GetVeROReasonCodeDetailsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetVeROReportStatusResponse: {
                    name: "GetVeROReportStatusResponse",
                    type: "GetVeROReportStatusResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetVeROReportStatusRequest: {
                    name: "GetVeROReportStatusRequest",
                    type: "GetVeROReportStatusRequest",
                    xmlRequired: true
                }
            }, ID: "message:GetVeROReportStatusRequest"
        }), isc.WSDLMessage.create({
            fields: {
                GetWantItNowPostResponse: {
                    name: "GetWantItNowPostResponse",
                    type: "GetWantItNowPostResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetWantItNowPostRequest: {
                    name: "GetWantItNowPostRequest",
                    type: "GetWantItNowPostRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GetWantItNowSearchResultsResponse: {
                    name: "GetWantItNowSearchResultsResponse",
                    type: "GetWantItNowSearchResultsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GetWantItNowSearchResultsRequest: {
                    name: "GetWantItNowSearchResultsRequest",
                    type: "GetWantItNowSearchResultsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GeteBayDetailsResponse: {
                    name: "GeteBayDetailsResponse",
                    type: "GeteBayDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                GeteBayDetailsRequest: {
                    name: "GeteBayDetailsRequest",
                    type: "GeteBayDetailsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                GeteBayOfficialTimeRequest: {
                    name: "GeteBayOfficialTimeRequest",
                    type: "GeteBayOfficialTimeRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                PlaceOfferResponse: {
                    name: "PlaceOfferResponse",
                    type: "PlaceOfferResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                PlaceOfferRequest: {
                    name: "PlaceOfferRequest",
                    type: "PlaceOfferRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                RelistItemResponse: {
                    name: "RelistItemResponse",
                    type: "RelistItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                RelistItemRequest: {
                    name: "RelistItemRequest",
                    type: "RelistItemRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                RemoveFromWatchListRequest: {
                    name: "RemoveFromWatchListRequest",
            ...
            fields: {
                RespondToBestOfferResponse: {
                    name: "RespondToBestOfferResponse",
                    type: "RespondToBestOfferResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                RespondToBestOfferRequest: {
                    name: "RespondToBestOfferRequest",
                    type: "RespondToBestOfferRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                RespondToFeedbackResponse: {
                    name: "RespondToFeedbackResponse",
                    type: "RespondToFeedbackResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                RespondToWantItNowPostResponse: {
                    name: "RespondToWantItNowPostResponse",
                    type: "RespondToWantItNowPostResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                RespondToWantItNowPostRequest: {
                    name: "RespondToWantItNowPostRequest",
            ...
            fields: {
                ReviseCheckoutStatusResponse: {
                    name: "ReviseCheckoutStatusResponse",
                    type: "ReviseCheckoutStatusResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseCheckoutStatusRequest: {
                    name: "ReviseCheckoutStatusRequest",
                    type: "ReviseCheckoutStatusRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseItemResponse: {
                    name: "ReviseItemResponse",
                    type: "ReviseItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseItemRequest: {
                    name: "ReviseItemRequest",
                    type: "ReviseItemRequest",
                    xmlRequired: true
                }
            }, ID: "message:ReviseItemRequest"
        }), isc.WSDLMessage.create({
            fields: {
                ReviseLiveAuctionItemResponse: {
                    name: "ReviseLiveAuctionItemResponse",
                    type: "ReviseLiveAuctionItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseLiveAuctionItemRequest: {
                    name: "ReviseLiveAuctionItemRequest",
                    type: "ReviseLiveAuctionItemRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseMyMessagesResponse: {
                    name: "ReviseMyMessagesResponse",
                    type: "ReviseMyMessagesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseMyMessagesRequest: {
                    name: "ReviseMyMessagesRequest",
                    type: "ReviseMyMessagesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseMyMessagesFoldersResponse: {
                    name: "ReviseMyMessagesFoldersResponse",
                    type: "ReviseMyMessagesFoldersResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ReviseMyMessagesFoldersRequest: {
                    name: "ReviseMyMessagesFoldersRequest",
                    type: "ReviseMyMessagesFoldersRequest",
                    xmlRequired: true
                }
            }, ID: "message:ReviseMyMessagesFoldersRequest"
        }), isc.WSDLMessage.create({
            fields: {
                SellerReverseDisputeResponse: {
                    name: "SellerReverseDisputeResponse",
                    type: "SellerReverseDisputeResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SellerReverseDisputeRequest: {
                    name: "SellerReverseDisputeRequest",
                    type: "SellerReverseDisputeRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetCartResponse: {
                    name: "SetCartResponse",
                    type: "SetCartResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetMessagePreferencesResponse: {
                    name: "SetMessagePreferencesResponse",
                    type: "SetMessagePreferencesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetMessagePreferencesRequest: {
                    name: "SetMessagePreferencesRequest",
                    type: "SetMessagePreferencesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetNotificationPreferencesResponse: {
                    name: "SetNotificationPreferencesResponse",
                    type: "SetNotificationPreferencesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPictureManagerDetailsResponse: {
                    name: "SetPictureManagerDetailsResponse",
                    type: "SetPictureManagerDetailsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPictureManagerDetailsRequest: {
                    name: "SetPictureManagerDetailsRequest",
                    type: "SetPictureManagerDetailsRequest",
                    xmlRequired: true
                }
            }, ID: "message:SetPictureManagerDetailsRequest"
        }), isc.WSDLMessage.create({
            fields: {
                SetPromotionRulesResponse: {
                    name: "SetPromotionRulesResponse",
                    type: "SetPromotionRulesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPromotionRulesRequest: {
                    name: "SetPromotionRulesRequest",
                    type: "SetPromotionRulesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPromotionalSaleResponse: {
                    ...
                    type: "SetPromotionalSaleResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPromotionalSaleRequest: {
                    name: "SetPromotionalSaleRequest",
                    type: "SetPromotionalSaleRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPromotionalSaleListingsResponse: {
                    name: "SetPromotionalSaleListingsResponse",
                    type: "SetPromotionalSaleListingsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetPromotionalSaleListingsRequest: {
                    name: "SetPromotionalSaleListingsRequest",
                    type: "SetPromotionalSaleListingsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetReturnURLResponse: {
                    name: "SetReturnURLResponse",
                    type: "SetReturnURLResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetReturnURLRequest: {
                    name: "SetReturnURLRequest",
                    type: "SetReturnURLRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetShippingDiscountProfilesResponse: {
                    name: "SetShippingDiscountProfilesResponse",
                    type: "SetShippingDiscountProfilesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetShippingDiscountProfilesRequest: {
                    name: "SetShippingDiscountProfilesRequest",
            ...
            fields: {
                SetStoreCategoriesResponse: {
                    name: "SetStoreCategoriesResponse",
                    type: "SetStoreCategoriesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetStoreCategoriesRequest: {
                    name: "SetStoreCategoriesRequest",
                    type: "SetStoreCategoriesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetStoreCustomPageResponse: {
                    name: "SetStoreCustomPageResponse",
                    type: "SetStoreCustomPageResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetStoreCustomPageRequest: {
                    name: "SetStoreCustomPageRequest",
                    type: "SetStoreCustomPageRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetStorePreferencesResponse: {
                    name: "SetStorePreferencesResponse",
                    type: "SetStorePreferencesResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetStorePreferencesRequest: {
                    name: "SetStorePreferencesRequest",
                    type: "SetStorePreferencesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetTaxTableResponse: {
                    name: "SetTaxTableResponse",
                    type: "SetTaxTableResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                SetTaxTableRequest: {
                    name: "SetTaxTableRequest",
                    type: "SetTaxTableRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetUserNotesRequest: {
                    name: "SetUserNotesRequest",
                    type: "SetUserNotesRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                SetUserPreferencesResponse: {
                    name: "SetUserPreferencesResponse",
            ...
            fields: {
                SetUserPreferencesRequest: {
                    name: "SetUserPreferencesRequest",
            ...
            fields: {
                ValidateChallengeInputResponse: {
                    name: "ValidateChallengeInputResponse",
                    type: "ValidateChallengeInputResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                ValidateChallengeInputRequest: {
                    name: "ValidateChallengeInputRequest",
            ...
            fields: {
                ValidateTestUserRegistrationResponse: {
                    name: "ValidateTestUserRegistrationResponse",
            ...
            fields: {
                ValidateTestUserRegistrationRequest: {
                    ...
                    type: "ValidateTestUserRegistrationRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                VeROReportItemsResponse: {
                    name: "VeROReportItemsResponse",
                    type: "VeROReportItemsResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                VeROReportItemsRequest: {
                    name: "VeROReportItemsRequest",
                    type: "VeROReportItemsRequest",
                    xmlRequired: true
                }
            ...
            fields: {
                VerifyAddItemResponse: {
                    name: "VerifyAddItemResponse",
                    type: "VerifyAddItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                VerifyAddSecondChanceItemResponse: {
                    name: "VerifyAddSecondChanceItemResponse",
                    type: "VerifyAddSecondChanceItemResponse",
                    xmlRequired: true
                }
            ...
            fields: {
                VerifyAddSecondChanceItemRequest: {
                    name: "VerifyAddSecondChanceItemRequest",
                    type: "VerifyAddSecondChanceItemRequest",
                    xmlRequired: true
                }
    ...
    isc.B.push(isc.A.setAuthToken = function isc_EBay_setAuthToken(_1) {
            this.$459 = _1
        }
        , isc.A.getAuthToken = function isc_EBay_getAuthToken() {
            if (this.$459) return this.$459;
            var _1 = this.$46a ? this.$46b : this.$46c;
            if (!_1) {
                this.logWarn("getAuthToken() called, but no token is available for the " + (this.$46a ? "production" : "sandbox") + " environment.  Please provide your token(s) by editing" + " /tools/visualBuilder/eBayAuthToken.js");
                return null
            }
            return _1
        }
        , isc.A.setSandboxToken = function isc_EBay_setSandboxToken(_1) {
            this.$46c = _1
        }
        , isc.A.setProductionToken = function isc_EBay_setProductionToken(_1) {
            this.$46b = _1
        }
        , isc.A.setUseProduction = function isc_EBay_setUseProduction(_1) {
            this.$46a = _1
        }
        , isc.A.getWebServiceEndpoint = function isc_EBay_getWebServiceEndpoint() {
            return this.$46a ? this.dataURL : this.sandboxEndpoint
        }
    );
    ...
    isc.B.push(isc.A.transformRequest = function isc_EBaySoapDataSource_transformRequest(_1) {
            _1.headerData = isc.addProperties({RequesterCredentials: {eBayAuthToken: isc.EBay.getAuthToken()}}, this.headerData);
            _1.actionURL = isc.EBay.getWebServiceEndpoint();
            _1.params = {callname: this.wsOperation, siteid: 0, version: this.soapVersion};
            _1.data.version = this.soapVersion;
            return _1.data
        }
    );
    ...
    isc.A.defaultCriteria = {LevelLimit: 1, CategorySiteID: 0, ViewAllNodes: true, DetailLevel: "ReturnAll"};
    isc.B.push(isc.A.transformRequest = function isc_EBayCategoriesDS_transformRequest(_1) {
            this.Super("transformRequest", arguments);
            if (_1.data.CategoryParent == null) delete _1.data.CategoryParent;
            var _2 = (_1.parentNode ? _1.parentNode.CategoryLevel : null);
            if (_2 != null) {
                _1.data.CategoryLevel = Number(_2) + 1;
                _1.data.LevelLimit = _1.data.CategoryLevel
            }
            return _1.data
        }
        , isc.A.transformResponse = function isc_EBayCategoriesDS_transformResponse(_1, _2, _3) {
            if (_2.data.CategoryLevel) {
                _1.data = _1.data.findAll("CategoryLevel", _2.data.CategoryLevel + "")
            }
            return _1
        }
    );
    ...
    isc.A.defaultCriteria = {DetailLevel: "ReturnAll", ItemTypeFilter: "AllItems"};
    isc.EBayGetItemDS.create({ID: "getItemDS", fields: [{name: "ItemID"}]});
    ...
    isc.B.push(isc.A.transformRequest = function isc_EBayCategoryItemListingsDS_transformRequest(_1) {
            this.Super("transformRequest", arguments);
            if (_1.startRow != null && _1.endRow != null) {
                var _2 = _1.endRow - _1.startRow + 1;
                var _3 = Math.ceil((_1.endRow + 1) / _2);
                if ((_1.endRow + 1) % _2 != 0) {
                    if ((_1.endRow + 1) < (_2 * 3)) {
                        _2 = _1.endRow + 1;
                        _3 = 1;
        ...
        , isc.A.transformResponse = function isc_EBayCategoryItemListingsDS_transformResponse(_1, _2, _3) {
            _1.data = _1.data || [];
            if (_1.data.length) {
                _1.startRow = _2.startRow;
                _1.endRow = _2.startRow + _1.data.length - 1;
                _1.totalRows = _3.selectNumber("//default:TotalNumberOfEntries")
            }
            return _1
        }
    );
    ...
    isc.D = isc._funcClasses;
    isc.D[isc.C] = isc.A.Class;
    isc.B.push(isc.A.isFolder = function isc_CategoryResultTree_isFolder(_1) {
            if (_1.LeafCategory) return _1.LeafCategory == "false";
            return this.Super("isFolder", arguments)
        }
    );
    isc.B._maxIndex = isc.C + 1;
    isc._moduleEnd = isc._EBay_end = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) isc.Log.logInfo('EBay module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn) isc.Log.logWarn("Duplicate load of module 'EBay'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
