...
if (window.isc && window.isc.module_Core && !window.isc.module_SalesForce) {
    ...
    isc._moduleStart = isc._SalesForce_start = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {
            message: 'SalesForce load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms',
            category: 'loadTime'
        };
    ...
    if (isc.SForce) {
        ...
        isc.A.detailFields = ["Id", "Type", "ParentId", "LastModifiedDate", "LastModifiedById", "LastActivityDate", "CreatedDate", "CreatedById"];
        isc.A.hiddenFields = ["SystemModstamp"];
        isc.B.push(isc.A.getHeaderData = function isc_SForce_getHeaderData(_1) {
                var _2 = {};
                if (_1.operationType == "fetch") _2.QueryOptions = {batchSize: 75};
                if (this.sessionId != null) _2.SessionHeader = {sessionId: this.sessionId};
                return _2
            }
            , isc.A.login = function isc_SForce_login(_1, _2, _3) {
                this.callOperation("login", {username: _1, password: _2}, "//default:result", {
                    target: this,
                    methodName: "loginReply"
                }, {willHandleError: true, $40z: _3, showPrompt: true, prompt: "Logging into SalesForce.."})
            }
            ...
            , isc.A.getEntity = function isc_SForce_getEntity(_1, _2) {
                var _3 = this;
                this.callOperation("describeSObjects", {sObjectType: _1}, null, function (_4) {
                    _3.describeObjectReply(_4, _1, _2)
                })
            }
            , isc.A.describeObjectReply = function isc_SForce_describeObjectReply(_1, _2, _3) {
            ...
            , isc.A.convertSchema = function isc_SForce_convertSchema(_1, _2) {
                ...
                for (var i = 0; i < _3.length; i++) {
                    var _6 = _3[i], _7 = {};
                    _7.name = _6.name;
                    if (this.detailFields.contains(_7.name)) _7.detail = true;
                    if (this.hiddenFields.contains(_7.name)) _7.hidden = true;
                    var _8 = _6.soapType;
                    if (_8.contains(":")) _8 = _8.substring(_8.indexOf(":") + 1);
                    _7.type = _8;
                    _7.title = _6.label;
                    _7.canEdit = _6.updateable;
                    if (_6.type == "id") _7.primaryKey = true;
                    if (_6.length != 0) _7.length = _6.length;
                    _4.add(_7)
                }
            ...
            , isc.A.installSControl = function isc_SForce_installSControl(_1, _2, _3, _4) {
        ...
        isc.D = isc._funcClasses;
        isc.D[isc.C] = isc.A.Class;
        isc.B.push(isc.A.transformData = function isc_SFResultSet_transformData(_1, _2) {
        ...
        isc.B.push(isc.A.transformRequest = function isc_SFDataSource_transformRequest(_1) {
                var _2 = _1.data;
                ...
                var _3 = _1.data,
                    _4 = "select " + this.getFieldNames().join(",") + " " + "from " + (this.sfName || this.ID);
            ...
            , isc.A.transformResponse = function isc_SFDataSource_transformResponse(_1, _2, _3) {
                ...
                var _9 = _1.data;
                for (var i = 0; i < _9.length; i++) {
                    if (isc.isAn.Array(_9[i].Id)) _9[i].Id = _9[i].Id[0]
                }
                return _1
            }
    ...
    isc._moduleEnd = isc._SalesForce_end = (isc.timestamp ? isc.timestamp() : new Date().getTime());
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) isc.Log.logInfo('SalesForce module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn) isc.Log.logWarn("Duplicate load of module 'SalesForce'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
