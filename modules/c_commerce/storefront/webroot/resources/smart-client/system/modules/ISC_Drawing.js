...
if (window.isc && window.isc.module_Core && !window.isc.module_Drawing) {
    ...
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {
            message: 'Drawing load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms',
            category: 'loadTime'
        };
    ...
    isc.B.push(isc.A.createQuadTree = function isc_DrawPane_createQuadTree() {
        ...
        , isc.A.drawBounds = function isc_DrawPane_drawBounds(_1) {
            isc.DrawRect.create({
                autoDraw: true,
                drawPane: this,
                left: Math.round(_1.bounds.x),
                top: Math.round(_1.bounds.y - _1.bounds.height),
                width: Math.round(_1.bounds.width),
                height: Math.round(_1.bounds.height)
            }, {lineColor: "#FF0000", lineOpacity: 0.1, lineWidth: 1, linePattern: "solid"});
        ...
        , isc.A.addDrawItem = function isc_DrawPane_addDrawItem(_1, _2) {
            if (_1.drawPane == this) return;
            if (_1.$if) _1.erase();
            _1.drawPane = this;
            if (!this.drawItems.contains(_1)) this.drawItems.add(_1);
            if (_2 == null) _2 = true;
            if (_2 && this.isDrawn()) {
                _1.draw()
            }
    ...
    isc.B.push(isc.A.getDefaultDrawPane = function isc_c_DrawPane_getDefaultDrawPane(_1) {
            if (!_1) _1 = this.defaultDrawingType;
            if (this.$44p[_1]) return this.$44p[_1];
            var _2 = this.$44p[_1] = this.create({
                drawingType: _1,
    ...
    isc.defineClass("DrawItem").addProperties({
        ...
        draw: function () {
            ...
            this.$if = true;
            if (this.knobs) {
                for (var i = 0; i < this.knobs.length; i++) this.$634(this.knobs[i])
            }
        },
        isDrawn: function () {
            return !!this.$if
        ...
        showKnobs: function (_1) {
            ...
            if (this.knobs.contains(_1)) return;
            this.knobs.add(_1);
            if (this.$if) {
                this.$634(_1)
            }
        ...
        hideKnobs: function (_1) {
            ...
            if (this.knobs.contains(_1)) this.knobs.remove(_1);
            if (this.$if) {
                this.$635(_1)
            }
        },
        ...
        showMoveKnobs: function () {
            ...
            this.$637 = this.createAutoChild("moveKnob", {
        ...
        handleResizeKnobMove: function (_1, _2, _3, _4, _5) {
            ...
            if (_8 < 1 || _9 < 1) return false;
            this.resizeTo(_8, _9);
            if (_10) this.moveTo(_6, _7)
        },
        ...
        erase: function (_1) {
            ...
            if (!_1) {
                if (this.drawGroup) this.drawGroup.drawItems.remove(this); else {
                    this.drawPane.drawItems.remove(this);
                    this.item && this.drawPane.quadTree.remove(this.item)
                }
            }
            if (this.drawingVML) {
                if (isc.Page.isLoaded()) this.$44u.outerHTML = ""; else this.$44t.removeChild(this.$44u);
                this.$44t = null;
                this.$44u = null;
                this.$44w = null;
                this.$44x = null
        ...
        drawBitmap: function (_1) {
            ...
            try {
                ...
                if (!isc.Log.supportsOnError) this.$am(e); else this.logWarn("exception during drawBitmap(): " + e)
            }
            _1.restore()
        },
        $442: function () {
            if (this.$444) {
                if (this.startArrow == "block") return this.$444;
        ...
        $443: function () {
            if (this.$448) {
                if (this.endArrow == "block") return this.$448;
        ...
        setLineOpacity: function (_1) {
            if (_1 != null) this.lineOpacity = _1;
            if (this.drawingVML) {
        ...
        $44r: {shortdot: 1, dot: 1, shortdash: 3, dash: 4, longdash: 8},
        $44s: {shortdot: 1, dot: 3, shortdash: 1, dash: 3, longdash: 3},
        $441: function () {
            var _1 = this.linePattern;
            if (!_1 || _1 == "solid" || _1 == "") return "none";
            if (isc.isAn.Array(_1)) return _1.join("px,") + "px";
            var _2 = this.$44r[_1];
            var _3 = this.$44s[_1];
        ...
        setStartArrow: function (_1) {
            var _2 = this.$63r();
            var _3;
            if (_1 !== _3) this.startArrow = _1; else _1 = this.startArrow;
            var _4 = this.$63r();
            if (_2 != _4) {
                this.setStartPoint()
            }
        ...
        setEndArrow: function (_1) {
            var _2 = this.$63s();
            var _3;
            if (_1 !== _3) this.endArrow = _1; else _1 = this.endArrow;
            var _4 = this.$63s();
            if (_2 != _4) {
                this.setEndPoint()
            }
        ...
        setFillOpacity: function (_1) {
            if (_1 != null) this.fillOpacity = _1;
            if (this.drawingVML) {
    ...
    isc.B.push(isc.A.init = function isc_DrawGroup_init() {
        ...
        , isc.A.drawBitmap = function isc_DrawGroup_drawBitmap(_1) {
            ...
            for (var i = 0; i < this.drawItems.length; i++) {
                if (!this.drawItems[i].hidden) this.drawItems[i].drawBitmap(_1)
            }
            _1.restore()
        }
    ...
    isc.B.push(isc.A.init = function isc_DrawLine_init() {
        ...
        , isc.A.drawBitmapPath = function isc_DrawLine_drawBitmapPath(_1) {
            var _2 = (this.lineWidth == 0 || parseInt(this.lineWidth) % 2) == 1 ? 0.5 : 0,
                _3 = parseFloat(this.startLeft) + _2, _4 = parseFloat(this.startTop) + _2,
                _5 = parseFloat(this.endLeft) + _2, _6 = parseFloat(this.endTop) + _2;
        ...
        , isc.A.setStartPoint = function isc_DrawLine_setStartPoint(_1, _2) {
            if (_1 != null) this.startLeft = _1;
            if (_2 != null) this.startTop = _2;
            if (this.drawingVML) {
        ...
        , isc.A.setEndPoint = function isc_DrawLine_setEndPoint(_1, _2) {
            if (_1 != null) this.endLeft = _1;
            if (_2 != null) this.endTop = _2;
            if (this.drawingVML) {
        ...
        , isc.A.showStartPointKnobs = function isc_DrawLine_showStartPointKnobs() {
            this.$639 = this.createAutoChild("startKnob", {
                _constructor: "DrawKnob",
                x: this.startLeft,
                y: this.startTop,
                drawPane: this.drawPane,
        ...
        , isc.A.showEndPointKnobs = function isc_DrawLine_showEndPointKnobs() {
            this.$64a = this.createAutoChild("endKnob", {
                _constructor: "DrawKnob",
                x: this.endLeft,
                y: this.endTop,
                drawPane: this.drawPane,
    ...
    isc.B.push(isc.A.getAttributesVML = function isc_DrawRect_getAttributesVML() {
        ...
        , isc.A.setCenter = function isc_DrawRect_setCenter(_1, _2) {
            if (_1 != null) _1 = _1 - Math.round(this.width / 2);
            if (_2 != null) _2 = _2 - Math.round(this.height / 2);
            this.moveTo(_1, _2)
        }
        ...
        , isc.A.resizeTo = function isc_DrawRect_resizeTo(_1, _2) {
            var _3 = 0, _4 = 0;
            if (_1 != null) _3 = _1 - this.width;
            if (_2 != null) _4 = _2 - this.height;
            this.resizeBy(_3, _4)
        }
        , isc.A.resizeBy = function isc_DrawRect_resizeBy(_1, _2) {
            if (_1 != null) this.width += _1;
            if (_2 != null) this.height += _2;
            if (this.drawingVML) {
    ...
    isc.B.push(isc.A.init = function isc_DrawOval_init() {
            if (!this.radius) this.$63t(); else this.$78s();
            this.Super("init")
        }
        ...
        , isc.A.setCenterPoint = function isc_DrawOval_setCenterPoint(_1, _2) {
            ...
            var _3 = 0, _4 = 0;
            if (_1 != null) _3 = _1 - this.centerPoint[0];
            if (_2 != null) _4 = _2 - this.centerPoint[1];
            this.moveBy(_3, _4)
        }
        , isc.A.moveBy = function isc_DrawOval_moveBy(_1, _2) {
            if (_1 != null) this.centerPoint[0] += _1;
            if (_2 != null) this.centerPoint[1] += _2;
            this.$78s();
            if (!this.$if) return;
            if (this.drawingVML) {
        ...
        , isc.A.resizeBy = function isc_DrawOval_resizeBy(_1, _2, _3) {
            ...
            if (_2 != null) this.height += _2;
            if (_3) {
                if (_1 != null) this.left += Math.round(_1 / 2);
                if (_2 != null) this.top += Math.round(_2 / 2)
            }
            this.$63t();
            if (this.drawingVML) {
                this.$44u.style.width = this.width;
            ...
            this.Super("resizeBy", arguments);
            this.resized(_1, _2);
            if (_3) this.moved(_1 / 2, _2 / 2)
        }
        , isc.A.resizeTo = function isc_DrawOval_resizeTo(_1, _2, _3) {
            var _4 = 0, _5 = 0;
            if (_1 != null) _4 = _1 - this.width;
            if (_2 != null) _5 = _2 - this.height;
    ...
    isc.B.push(isc.A.init = function isc_DrawLabel_init() {
        ...
        , isc.A.makeHTMLText = function isc_DrawLabel_makeHTMLText() {
            var _1 = this.$45c = isc.HTMLFlow.create({
                ...
                width: 1,
                height: 1,
                contents: isc.SB.concat("<span style='font-family:", this.fontFamily, ";font-weight:", this.fontWeight, ";font-size:", Math.round(this.fontSize * this.drawPane.zoomLevel), ";font-style:", this.fontStyle, ";color:", this.lineColor, ";white-space:nowrap'>", this.contents, "</span>"),
                autoDraw: false
            });
    ...
    isc.B.push(isc.A.init = function isc_DrawCurve_init() {
        ...
        , isc.A.setStartPoint = function isc_DrawCurve_setStartPoint(_1, _2) {
            if (_1 != null) this.startPoint[0] = _1;
            if (_2 != null) this.startPoint[1] = _2;
            if (this.drawingVML) {
        ...
        , isc.A.setEndPoint = function isc_DrawCurve_setEndPoint(_1, _2) {
            if (_1 != null) this.endPoint[0] = _1;
            if (_2 != null) this.endPoint[1] = _2;
            if (this.drawingVML) {
        ...
        , isc.A.setControlPoint1 = function isc_DrawCurve_setControlPoint1(_1, _2) {
            if (_1 != null) this.controlPoint1[0] = _1;
            if (_2 != null) this.controlPoint1[1] = _2;
            if (this.drawingVML) {
        ...
        , isc.A.setControlPoint2 = function isc_DrawCurve_setControlPoint2(_1, _2) {
            if (_1 != null) this.controlPoint2[0] = _1;
            if (_2 != null) this.controlPoint2[1] = _2;
            if (this.drawingVML) {
        ...
        , isc.A.showControlPoint1Knobs = function isc_DrawCurve_showControlPoint1Knobs() {
            this.$64b = this.createAutoChild("c1Knob", {
                _constructor: "DrawKnob",
            ...
            this.$64c = this.createAutoChild("c1Line", {
                _constructor: "DrawLine",
                startLeft: this.startPoint[0],
                startTop: this.startPoint[1],
                endLeft: this.controlPoint1[0],
                endTop: this.controlPoint1[1],
                drawPane: this.drawPane,
                autoDraw: true
            });
        ...
        , isc.A.showControlPoint2Knobs = function isc_DrawCurve_showControlPoint2Knobs() {
            this.$64d = this.createAutoChild("c2Knob", {
                _constructor: "DrawKnob",
            ...
            this.$64e = this.createAutoChild("c2Line", {
                _constructor: "DrawLine",
                startLeft: this.endPoint[0],
                startTop: this.endPoint[1],
                endLeft: this.controlPoint2[0],
                endTop: this.controlPoint2[1],
                drawPane: this.drawPane,
                autoDraw: true
            });
        ...
        , isc.A.updateControlKnobs = function isc_DrawCurve_updateControlKnobs() {
            ...
            if (this.$639 || this.$64c) {
                ...
                if (this.$64c) this.$64c.setStartPoint(_1, _2);
                if (this.$639) {
            ...
            if (this.$64a || this.$64e) {
                ...
                if (this.$64e) this.$64e.setStartPoint(_1, _2);
                if (this.$64a) {
                    var _3 = this.drawPane.drawing2screen([_1, _2, 0, 0]);
                    this.$64a.setCenterPoint(_3[0], _3[1])
                }
    ...
    isc.B.push(isc.A.init = function isc_DrawLinePath_init() {
        ...
        , isc.A.drawBitmapPath = function isc_DrawLinePath_drawBitmapPath(_1) {
            var _2 = 10;
            if (this.startLeft > this.endLeft) _2 = -_2;
    ...
    isc.GraphMath = {
        zeroPoint: [0, 0], polar2screen: function (_1, _2, _3, _4) {
    ...
    isc.B.push(isc.A.initWidget = function isc_DrawKnob_initWidget() {
        ...
        , isc.A.$64f = function isc_DrawKnob__updatePoints() {
            var _1 = isc.EH.getX() -
                (this.drawPane.getPageLeft() + this.drawPane.getLeftMargin() + this.drawPane.getLeftBorderSize()),
                _2 = isc.EH.getY() -
    ...
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) isc.Log.logInfo('Drawing module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn) isc.Log.logWarn("Duplicate load of module 'Drawing'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
