    ...
    <div class="footer">
        ...
        <div id="footer-section" class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="logo">
                        <a class="store-name" href="<c:url value="/shop/"/>"><c:out
                                value="${requestScope.MERCHANT_STORE.storeName}"/></a>
                    </div>
                </div>
            </div>
                        ...
                        <c:if test="${not empty requestScope.CONTENT_PAGE}">
                            ...
                            <ul class="footerLiks">
                                <c:forEach items="${requestScope.CONTENT_PAGE}" var="content">
                                    <li><a href="<c:url value="/shop/pages/${content.seUrl}.html"/>"
                                           class="current">${content.name}</a></li>
                                </c:forEach>
                                <c:if test="${requestScope.CONFIGS['displayContactUs']==true}">
                                    <li><a href="<c:url value="/shop/store/contactus.html"/>"><s:message
                        ...
                        <div class="footer-content">
                            ...
                            <c:if test="${requestScope.CONFIGS['displayCustomerSection'] == true}">
                                ...
                                <sec:authorize access="hasRole('AUTH_CUSTOMER') and fullyAuthenticated">
                                    <li><a href="<c:url value="/shop/customer/account.html"/>"><s:message
                                        code="menu.profile" text="Profile"/></a></li>
                                    <li><a href="<c:url value="/shop/customer/billing.html"/>"><s:message
                                        code="label.customer.billingshipping" text="Billing & shipping information"/></a></li>
                                ...
                                <sec:authorize access="!hasRole('AUTH_CUSTOMER') and fullyAuthenticated">
                                    ...
                                    <s:message code="label.security.loggedinas"
                                        ...
                                        text="We can't display store logon box"/>
                                    </li>
                                </sec:authorize>
                                <sec:authorize access="!hasRole('AUTH_CUSTOMER') and !fullyAuthenticated">
