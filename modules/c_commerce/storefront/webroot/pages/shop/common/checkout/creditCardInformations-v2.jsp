                ...
                <div class="col-md-12">
                    <div class="checkout-form-list">
                        <label class="control-label"><s:message
                                code="label.payment.creditcard.cardnumber" text="Card number"/><span
                    ...
                    <div class="checkout-form-list">
                        ...
                        <a href="#!" id="cvvImage" rel="popover">
                            <label class="control-label">
                                <s:message code="label.payment.creditcard.whatiscvv"
                                           text="What is a credit card validation number?"/>
                            </label>
                        </a>
                    </div>
                </div>
