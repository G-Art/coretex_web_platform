...
<script>$.ajax({
    url: "<c:url value="/shop/reference/creditCardDates.html"/>", type: "GET", success: function (data) {
        populateData($('#expiration-year-select'), data, '${order.payment['creditcard_card_expirationyear']}');
    }
})</script>
<script>$.ajax({
    url: "<c:url value="/shop/reference/monthsOfYear.html"/>", type: "GET", success: function (data) {
        populateData($('#expiration-month-select'), data, '${order.payment['creditcard_card_expirationmonth']}');
    }
})</script>
...
<div id="creditCardBoxBraintree" class="panel panel-default bootstrap-basic credit-card-box-v2">
    <form class="panel-body">
        <div class="row"
             style="margin-left:15px !important;margin-right:5px !important;margin-top:15px !important;margin-bottom:15px !important">
        ...
        <div class="row"
             style="margin-left:5px !important;margin-right:5px !important;margin-top:15px !important;margin-bottom: 0px !important">
            <div class="form-group col-sm-12">
                ...
                <div class="form-control" id="creditcard_card_number" name="payment['creditcard_card_number']"
                     autocomplete="off"></div>
                <span class="helper-text"></span>
            </div>
        </div>
        <div class="row"
             style="margin-left:5px !important;margin-right:5px !important;margin-top:0px !important;margin-bottom:0px !important">
        ...
        <div class="row"
            ...
            <div class="form-group col-sm-6">
                <label class="control-label"><s:message code="label.generic.postalcode"
                                                        text="Card owner postal code"/></label>
                <!--  Hosted Fields div container -->
...
<div class="control-group">
    <label class="control-label"><s:message code="label.payment.creditcard.usecredicard"
                                            text="Use Credit Card"/></label>
    <div class="controls">
