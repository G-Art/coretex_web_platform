                    ...
                    <c:when test="${not empty cart.shoppingCartItems}">
                        <c:forEach items="${cart.shoppingCartItems}"
                            ...
                            <form:form action="${updateShoppingCartItemUrl}"
                                       id="shoppingCartLineitem_${shoppingCartItem.uuid}">
                                <tr>
                                    <td
                                    ...
                                    <td width="10%"
                                        ...
                                        <input type="number"
                                               ...
                                               id="${shoppingCartItem.uuid}"
                                               <c:if test="${shoppingCartItem.productVirtual==true}">readonly</c:if>>
                                    </td>

                                    <td
                                            data-th="<s:message code="label.generic.price" text="Price"/>">
                                    ...
                                    <td width="10%" class="actions" data-th="">
                                        <button type="button" class="btn btn-danger btn-sm"
                                                onclick="updateLineItem('${shoppingCartItem.uuid}','${removeShoppingCartItemUrl}'); return false;"
                                                style="margin-top: 0px !important;">
                                            <i class="fa fa-trash-o"></i>&nbsp;
                                            <s:message code="label.generic.remove" text="Remove"/>
                                        </button>
                                        <input type="hidden" name="lineItemId" id="lineItemId"
                                               value="${shoppingCartItem.uuid}"/>
                                    </td>
                        ...
                        <tr>
                            <td colspan="3"><a href="#"
                                               onClick="updateCart('#mainCartTable');"
