            ...
            <table class="table" style="margin-bottom: 35px">
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td style="border-top: none;"><a class="details"
                                        ...
                                        value="${product.description.name}"/></a></td>
                            </tr>
                            <tr>
            ...
            <sec:authorize access="hasRole('AUTH_CUSTOMER') and fullyAuthenticated">
                <c:choose>
                    <c:when test="${customerReview!=null}">
                        <p>
                                <s:message code="label.product.reviews.evaluated"
                                           text="You have evaluated this product"/>
                            <br/>
                        <div class="stars" id="customerRating" style="width: 100px;"></div>
                        <br/>
                        <blockquote>
                            <p><c:out value="${customerReview.description}" escapeXml="false"/></p>
                            <small><c:out value="${customerReview.customer.firstName}"/>&nbsp;<c:out
                                    value="${customerReview.customer.lastName}"/>&nbsp;<c:out
                                    value="${customerReview.date}"/></small>
                        </blockquote>
                        </p>
                        <script>
                            $(function () {
                        ...
                        <form:form method="POST" modelAttribute="review" action="${submitReview}">
                            ...
                            <fieldset>
                                ...
                                <div class="control-group form-group">
                                    ...
                                    <div class="controls">
                                        <form:textarea name="" rows="6" class="span8 input form-control form-control-md"
                                                       path="description"/>
                                        <label>&nbsp;</label>
                                        <span class="help-block"><s:message code="label.product.clickrate"
                                                                            text="Product rating (click on the stars to activate rating)"/></span>
