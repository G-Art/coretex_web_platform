					...
					<span class="box-title">
						<p class="p-title">
							  ...
							  <c:choose>
                                  ...
                                  <c:otherwise>
                                      <s:message code="label.customer.edit.shippinginformation"
                ...
                <form:form method="POST" id="changeAddressForm" modelAttribute="address" action="${updateAddress}">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <s:message code="NotEmpty.customer.firstName" text="First name is required"
                                       var="msgFirstName"/>
                            <form:input cssClass="input-large required form-control form-control-md" maxlength="64"
                                        path="firstName" title="${msgFirstName}"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <s:message code="NotEmpty.customer.lastName" text="Last name is required"
                                       var="msgLastName"/>
                            <form:input cssClass="input-large required form-control form-control-md" maxlength="64"
                                        path="lastName" title="${msgLastName}"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large form-control form-control-md" maxlength="100"
                                        path="company"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large required form-control form-control-md" maxlength="256"
                                        path="address" title="${msgAddress}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large required form-control form-control-md" maxlength="100"
                                        path="city" title="${msgCity}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <form:select cssClass="billing-country-list form-control form-control-lg" path="country"
                                         id="customer_country">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <form:select cssClass="billing-zone-list form-control form-control-lg" path="zone"
                                         id="customer_zones"/>
                            <s:message code="NotEmpty.customer.stateProvince" text="State / Province is required"
                                       var="msgStateProvince"/>
                            <form:input class="input-large required form-control form-control-md" id="hidden_zones"
                                        maxlength="100" name="stateProvince" path="stateProvince"
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <s:message code="NotEmpty.customer.billing.postalCode" text="Postal code is required"
                                       var="msgPostalCode"/>
                            <form:input id="billingPostalCode"
                                        cssClass="input-large required customer-postalCode form-control form-control-md"
                                        maxlength="20" path="postalCode" title="${msgPostalCode}"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <s:message code="NotEmpty.customer.billing.phone" text="Phone number is required"
                                       var="msgPhone"/>
                            <form:input cssClass="input-large required customer-phone form-control form-control-md"
                                        maxlength="32" path="phone" title="${msgPhone}"/>
                    ...
                    <div class="form-actions">
                        <input id="submitAddress" class="btn btn-large btn-disabled template-btn" type="submit"
                               name="submitAddress" value="<s:message code="menu.editaddress" text="Change address"/>"
                               disabled="">
                    </div>
