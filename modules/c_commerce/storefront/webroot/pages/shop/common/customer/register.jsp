...
<div id="main-content" class="container clearfix row-fluid">
    ...
    <div class="span5 col-md-7 no-padding">
        <form:form method="post" action="${register_url}" id="registrationForm" class="form-horizontal"
            ...
            <fieldset>
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        ...
                        <form:input path="billing.firstName"
                                    cssClass="span8 required input form-control form-control-md" id="firstName"
                                    title="${msgFirstName}"/>
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        ...
                        <form:input path="billing.lastName" cssClass="span8 required form-control form-control-md"
                ...
                <div class="control-group form-group">
                    <label class="required control-label" for="sex"><s:message code="label.generic.genre"
                                                                               text="Genre"/></label>
                    <div class="controls">
                        <form:select path="gender" class="form-control form-control-lg">
                            <form:option value="male"><s:message code="label.generic.male" text="Male"/></form:option>
                            <form:option value="female"><s:message code="label.generic.female" text="Female"/></form:option>
                        </form:select>
                ...
                <div class="control-group form-group">
                    <label class="control-label required"><s:message code="label.generic.country"
                                                                     text="Country"/></label>
                    <div class="controls">
                        <form:select path="billing.country" class="form-control form-control-lg"
                ...
                <div class="control-group form-group">
                    <label class="control-label required"><s:message code="label.generic.stateprovince"
                                                                     text="State / Province"/></label>
                    <div class="controls">
                        <s:message code="NotEmpty.customer.billing.stateProvince" text="State / Province is required"
                                   var="msgStateProvince"/>
                        <form:select path="billing.zone" id="customer_zones" class="form-control form-control-lg">
                        </form:select>
                        <form:input path="billing.stateProvince" cssClass="span8 required form-control form-control-md"
                ...
                <div class="control-group form-group">
                    <label class="required control-label" for="username"><s:message code="label.generic.username"
                                                                                    text="User name"/></label>
                    <div class="controls">
                        <s:message code="NotEmpty.customer.userName" text="User name is required" var="msgUserName"/>
                        <form:input path="userName" cssClass="span8 required userName form-control form-control-md"
                ...
                <div class="control-group form-group">
                    <label class="required control-label" for="email"><s:message code="label.generic.email"
                                                                                 text="Email address"/></label>
                    <div class="controls">
                        <s:message code="NotEmpty.customer.emailAddress" text="Email address is required"
                                   var="msgEmail"/>
                        <form:input path="emailAddress" cssClass="span8 required email form-control form-control-md"
                ...
                <div class="control-group form-group">
                    <label class="required control-label" for="password"><s:message code="label.generic.password"
                                                                                    text="Password"/></label>
                    <div class="controls">
                        <s:message code="message.password.required" text="Password is required" var="msgPassword"/>
                        <form:password path="password" class="span8 required password form-control form-control-md"
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <s:message code="message.password.repeat.required" text="Repeated password is required"
                                   var="msgRepeatPassword"/>
                ...
                <div class="form-actions">
                    <input id="submitRegistration" type="submit"
                           value="<s:message code="label.generic.register" text="Register"/>" name="register"
                           class="btn btn-large template-btn">
                </div>
            </fieldset>
        </form:form>
