                ...
                <form:form method="POST" modelAttribute="configuration" action="${saveAccountsConfiguration}">
                    ...
                    <c:forEach var="merchantConfig" items="${configuration.merchantConfigs}" varStatus="counter">
                        ...
                        <div class="control-group">
                            <label><s:message code="label.configuration.${merchantConfig.key}"
                            ...
                            <div class="controls">
                                ...
                                <form:hidden path="merchantConfigs[${counter.index}].uuid"/>
                                <span class="help-inline"><form:errors path="merchantConfigs[${counter.index}].key"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
