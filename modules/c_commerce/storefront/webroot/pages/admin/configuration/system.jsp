        ...
        <div class="tab-pane active" id="admin-cache">
            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="configuration" action="${saveSystemConfiguration}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.customer.displaycustomersection"
                                          text="Display customer section"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.displaycontactussection"
                                          text="Display contact us page"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.order.displayagreement"
                                          text="Display customer terms and policy agreement in order page"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.displayaddtocartfeatured"
                                          text="Allow add to cart on featured items"/></label>
                        <div class="controls">
