            ...
            <div class="sm-ui-component">
                ...
                <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <form class="form-inline">
                                    <button id="${key}" type="submit" class="btn clear-cache"><s:message
                                            code="button.label.clear" text="Clear"/></button>
                                    <br/>
                                </form>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="submit" class="btn clear-all-cache"><s:message code="button.label.clear"
                                                                                         text="Clear"/></button>
                        </td>
                    </tr>
                </table>
