            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="configuration" action="${saveEmailConfiguration}">
                    ...
                    <div class="control-group">
                        ...
                        <span class="help-inline"><s:message code="label.emailconfig.requiresauthentication"
                                                             text="Email server requires authentication (should be set to true)"/></span>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <span class="help-inline"><s:message code="label.emailconfig.requiresstarttls"
                                                             text="Email server requires STARTLS encryption (should be false, check server configurations)"/></span>
                    </div>
