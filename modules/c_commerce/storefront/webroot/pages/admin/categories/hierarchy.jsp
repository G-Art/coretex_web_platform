    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <br/>
                <div class="well">
                    <s:message code="label.category.hierarchy.text"
                               text="Drag categories to re-organize the hierarchy"/>
                </div>
                <br/>
                    ...
                    isc.HLayout.create({
                        ...
                        members: [
                            ...
                            isc.SectionStack.create({
                                ...
                                sections: [
                                    {
                                        title: "<s:message code="label.categories.hierarchy.title" text="Category hierarchy"/>",
                                        autoShow: true,
                                        items: [categoryTree]
                                    }
                                ]
