        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <form:form method="POST" enctype="multipart/form-data" action="${saveBrandingImage}">
                ...
                <div class="control-group">
                    <label><s:message code="label.storelogo" text="Store logo"/>&nbsp;<c:if
                            test="${store.storeLogo!=null}"><span id="imageControlRemove"> - <a href="#"
                                                                                                onClick="removeImage('${store.id}')"><s:message
