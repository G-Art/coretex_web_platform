        ...
        <c:forEach items="${storeLanding.descriptions}" var="description" varStatus="counter">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><form:errors path="descriptions[${counter.index}].description"
                                                           cssClass="error"/></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><form:errors path="descriptions[${counter.index}].keywords"
                                                           cssClass="error"/></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
		                        ...
		                        <textarea cols="30" id="descriptions[${counter.index}].homePageContent" class="ckeditor"
                                          name="descriptions[${counter.index}].homePageContent">
