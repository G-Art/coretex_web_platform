            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="configuration" action="${savePackaging}">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <form:radiobutton id="shipPackageType" path="shipPackageType" value="ITEM"/>&nbsp;<s:message
                                code="label.shipping.packaging.individual"
                                text="Items will be shipped individually"/><br/>
                            <form:radiobutton id="shipPackageType" path="shipPackageType" value="BOX"/>&nbsp;<s:message
                                code="label.shipping.packaging.boxes"
                                text="Items will be combined and shipped in a box"/><br/>
                        </div>
                    </div>
                    <div class="well">
                        <div class="control-group">
                            <div class="controls">
                                <s:message code="label.store.weightunit" text="Weight units"/>&nbsp;<strong><c:out
                                    value="${store.weightUnitCode}"/></strong><br/>
                                <s:message code="label.store.sizeunits" text="Size units"/>&nbsp;<strong><c:out
                                    value="${store.seizeUnitCode}"/></strong><br/>
                            </div>
                        </div>
                        <div class="control-group">
