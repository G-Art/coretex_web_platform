    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="shipping-config">
            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="configuration" action="${shippingConfigurationSave}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="controls">
                                <form:radiobutton id="shipType" path="shipType" value="NATIONAL"/>&nbsp;<s:message
                                    code="label.shipping.national" text="National"/>
                                <form:radiobutton id="shipType" path="shipType" value="INTERNATIONAL"/>&nbsp;<s:message
                                    code="label.shipping.international" text="International"/>
                ...
                <c:set var="gridHeader" value="/pages/admin/shipping/shipping-countries-gridHeader.jsp"
                       scope="request"/>
