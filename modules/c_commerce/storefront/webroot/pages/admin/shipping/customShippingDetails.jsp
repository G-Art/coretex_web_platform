    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="shipping-section">
            ...
            <div class="sm-ui-component">
                <a href="<c:url value="/admin/shipping/weightBased.html"/>"><s:message code="label.generic.back"
                                                                                       text="Back"/></a><br/><br/>
                <h3><s:message code="module.shipping.weightBased" text="module.shipping.weightBased"/> - <c:out
                        value="${customRegion.customRegionName}"/></h3>
                <br/>
                ...
                <form:form method="POST" modelAttribute="customQuote" action="${addPrice}">
                    ...
                    <div class="control-group">
                        ...
                        <span id="help-priceText" class="help-inline"><form:errors path="priceText"
                                                                                   cssClass="error"/></span>
                    </div>
                ...
                <c:set value="/admin/shipping/weightBasedDetails/page.html?region=${customRegion.customRegionName}"
                       var="pagingUrl" scope="request"/>
                <c:set value="/admin/shipping/weightBased/removePrice.html?region=${customRegion.customRegionName}"
                       var="removeUrl" scope="request"/>
                <c:set var="entityId" value="maximumWeight" scope="request"/>
                <c:set value="/admin/shipping/weightBased/edit.html?customRegionName=${customRegion.customRegionName}"
                       var="afterRemoveUrl" scope="request"/>
                <c:set var="componentTitleKey" value="module.shipping.weightBased" scope="request"/>
                <c:set var="gridHeader" value="/pages/admin/shipping/weightBasedDetails-gridHeader.jsp"
                       scope="request"/>
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="region" action="${removeRegion}">
                    ...
                    <div class="form-actions">
                        <div class="pull-right">
                            <button type="submit" class="btn-danger"><i class="icon-trash icon-large"></i><s:message
                                    code="label.generic.remove" text="Remove"/></button>
                        </div>
                    </div>
