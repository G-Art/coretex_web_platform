    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <h3>
                    <s:message code="menu.catalogue-products-images" text="Images library"/>&nbsp;<s:message
                        code="label.generic.url" text="URL"/>
                </h3>
                <br/>
                ...
                <form:form method="POST" modelAttribute="productImage" action="${saveProductImage}">
                    ...
                    <div class="control-group" style="margin-top:15px;">
                        ...
                        <div class="controls">
                            ...
                            <input type="hidden" name="id" id="id" value="${product.uuid}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-success"><s:message code="button.label.add"
                                                                                     text="Add"/></button>
                ...
                <c:set value="/admin/products/images/url/page.html?productId=${product.uuid}" var="pagingUrl"
                       scope="request"/>
                <c:set value="/admin/products/images/remove.html" var="removeUrl" scope="request"/>
                <c:set value="/admin/products/images/url/list.html?id=${product.uuid}" var="refreshUrl" scope="request"/>
                <c:set var="componentTitleKey" value="menu.catalogue-products-images" scope="request"/>
                <c:set var="canRemoveEntry" value="true" scope="request"/>
                <c:set var="gridHeader" value="/pages/admin/products/product-images-url-gridHeader.jsp"
                       scope="request"/>
