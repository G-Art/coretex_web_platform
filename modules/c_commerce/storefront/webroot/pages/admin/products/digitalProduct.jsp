...
<div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <form:form method="POST" enctype="multipart/form-data" modelAttribute="productFiles"
                       action="${saveProductFile}">
                ...
                <div class="control-group">
                    <label>
                        <s:message code="label.product.digitalproduct" text="Digital product"/>&nbsp;
                        <c:if test="${digitalProduct!=null}"><span id="productControlRemove"> - <a href="#"
                                                                                                   onClick="removeFile('${digitalProduct.id}')"><s:message
                                code="label.generic.remove" text="Remove"/></a></span></c:if>
                    </label>
