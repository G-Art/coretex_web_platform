            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="attribute" action="${attributeSave}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.product.attribute.option.name"
                                          text="Option / attribute name"/></label>
                        <div class="controls">
                            <div class="controls">
                                <form:select cssClass="highlight" id="productOption" path="productOption.uuid">
                    ...
                    <div class="control-group" id="optionValue" style="display:
                    <c:choose>
                    <c:when test="${attribute.productOption.productOptionType=='text'}">none;</c:when>
                        <c:otherwise>block;</c:otherwise></c:choose>">
                        <label><s:message code="label.product.productoptiosvalue.title"
                                          text="Option value name"/></label>
                        <div class="controls">
                            <div class="controls">
                                <form:select cssClass="highlight" path="productOptionValue.uuid">
                                    <form:options items="${optionsValues}" itemValue="uuid"
                                                  itemLabel="descriptionsSettoList[0].name"/>
                                </form:select>
                                <span class="help-inline"><form:errors path="productOptionValue.uuid"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="attributeValueText" style="display:
                    <c:choose>
                    <c:when test="${attribute.productOption.productOptionType=='text'}">block;</c:when>
                        <c:otherwise>none;</c:otherwise></c:choose>">
                        <c:forEach items="${attribute.productOptionValue.descriptionsSettoList}" var="description"
                                   varStatus="counter">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span id="help-price" class="help-inline"><form:errors path="attributePrice"
                                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.product.attribute.otherweight"
                                                           text="Additional weight"/></label>
                        <div class="controls">
                            <form:input id="weight" cssClass="highlight" path="attributeAdditionalWeight"/>
                            <span class="help-inline"><form:errors path="attributeAdditionalWeight"
                                                                   cssClass="error"/></span>
