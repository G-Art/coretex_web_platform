                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="optionValue" action="${optionSave}">
                    ...
                    <c:forEach items="${optionValue.descriptionsSettoList}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <form:input cssClass="highlight" id="name${counter.index}"
                    ...
                    <div class="control-group">
                        <label><s:message code="label.product.image" text="Image"/>&nbsp;<c:if
                                test="${optionValue.productOptionValueImage!=null && optionValue.productOptionValueImage!=''}"><span
                                id="imageControlRemove"> - <a href="#"
                                                              onClick="removeImage('${optionValue.id}')"><s:message
                        ...
                        <div class="controls" id="imageControl">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img src="<c:url value=""/><sm:contentImage imageName="${optionValue.productOptionValueImage}" imageType="PROPERTY"/>"
                                         width="80">
                                </c:otherwise>
                            </c:choose>
                        </div>
