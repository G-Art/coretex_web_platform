                ...
                <form:form method="POST" modelAttribute="price" action="${saveProductPrice}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span id="help-price" class="help-inline"><form:errors path="priceText"
                                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <c:forEach items="${price.descriptions}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline"><form:errors path="descriptions[${counter.index}].name"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.product.price.special"
                                                           text="Special price"/></label>
                        <div class="controls">
                            <form:input id="productSpecialPriceAmount" cssClass="" path="specialPriceText"/>
                            <span id="help-special-price" class="help-inline"><form:errors path="specialPriceText"
                                                                                           cssClass="error"/></span>
                        </div>
                    </div>

                    <div class="control-group">
                        <label><s:message code="label.product.price.special.startdate"
                                          text="Special start date"/></label>
                        <div class="controls">
                            <input name="productPriceSpecialStartDate" id="productPriceSpecialStartDate"
                                   value="${price.price.productPriceSpecialStartDate}" class="small" type="text"
                                   data-datepicker="datepicker">
                            <span class="help-inline"><form:errors path="productPriceSpecialStartDate"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="productPriceSpecialEndDate" id="productPriceSpecialEndDate"
                                   value="${price.price.productPriceSpecialEndDate}" class="small" type="text"
                                   data-datepicker="datepicker">
                            <span class="help-inline"><form:errors path="productPriceSpecialEndDate"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
