        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <div class="alert alert-info">
                    <s:message code="label.product.group.meassage"
                               text="Drag and drop product from product list to the product group box"/>
                </div>

                <!-- Listing grid include -->
                <c:set value="/admin/products/paging.html" var="pagingUrl" scope="request"/>
                <c:set value="/admin/products/group/details/paging.html?code=${group}" var="containerFetchUrl"
                       scope="request"/>
                <c:set value="/admin/products/group/details/removeItem.html?code=${group}" var="containerRemoveUrl"
                       scope="request"/>
                <c:set value="/admin/products/group/details/addItem.html?code=${group}" var="containerAddUrl"
                       scope="request"/>
