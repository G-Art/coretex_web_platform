            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="group" action="${saveProductGrop}">
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.product.customgroup.code"
                                                           text="Custom product group code"/></label>
                        <div class="controls">
                ...
                <c:set var="gridHeader" value="/pages/admin/products/customProductGroup-gridHeader.jsp"
                       scope="request"/>
