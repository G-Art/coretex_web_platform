        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <div class="alert alert-info">
                    <s:message code="label.product.related.meassage"
                               text="Drag and drop product from product list to related items box"/>
                </div>

                <!-- Listing grid include -->
                <c:set value="/admin/products/paging.html" var="pagingUrl" scope="request"/>
                <c:set value="/admin/catalogue/related/paging.html?productId=${productId}" var="containerFetchUrl"
                       scope="request"/>
                <c:set value="/admin/catalogue/related/removeItem.html?baseProductId=${productId}"
                       var="containerRemoveUrl" scope="request"/>
                <c:set value="RELATED" var="removeEntity" scope="request"/>
                <c:set value="/admin/catalogue/related/addItem.html?baseProductId=${productId}" var="containerAddUrl"
                       scope="request"/>
