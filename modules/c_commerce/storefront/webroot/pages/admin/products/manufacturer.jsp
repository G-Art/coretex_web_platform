            ...
            <h3>
                <c:choose>
                    <c:when test="${manufacturer.manufacturer.id!=null && manufacturer.manufacturer.id>0}">
                        <s:message code="label.manufacturer.edit" text="Edit Manufacturer"/> <c:out
                ...
                <c:forEach items="${manufacturer.descriptions}" var="description" varStatus="counter">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="descriptions[${counter.index}].title"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="descriptions[${counter.index}].url"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
