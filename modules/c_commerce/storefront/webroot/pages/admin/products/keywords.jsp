    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="productKeyword"
                           action="${addKeyword}">
                ...
                <c:set value="/admin/products/product/keywords/paging.html?id=${product.uuid}" var="pagingUrl"
                       scope="request"/>
                <c:set value="/admin/products/product/removeKeyword.html?id=${product.uuid}" var="removeUrl"
                       scope="request"/>
                <c:set value="/admin/products/product/keywords.html?id=${product.uuid}" var="afterRemoveUrl"
                       scope="request"/>
