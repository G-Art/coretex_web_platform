    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <c:set value="/admin/products/reviews/paging.html?productId=${product.uuid}" var="pagingUrl"
                       scope="request"/>
                <c:set value="/admin/products/reviews/remove.html" var="removeUrl" scope="request"/>
                <c:set value="/admin/products/reviews/paging.html?productId=${product.uuid}" var="refreshUrl"
                       scope="request"/>
