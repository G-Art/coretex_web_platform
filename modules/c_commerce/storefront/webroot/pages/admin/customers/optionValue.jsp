            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="optionValue" action="${optionSave}">
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.customer.optionvalue.code"
                                                           text="Option value code"/> </label>
                        <div class="controls">
                    ...
                    <c:forEach items="${optionValue.descriptionsSettoList}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            <label class="required"><s:message code="label.customer.optionvalue.name"
                                                               text="Option name"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="highlight x-large" id="name${counter.index}"
