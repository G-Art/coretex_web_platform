            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="option" action="${optionSave}">
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.customer.option.code"
                                                           text="Option code"/> </label>
                        <div class="controls">
                    ...
                    <c:forEach items="${option.descriptionsSettoList}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            <label class="required"><s:message code="label.customer.option.name" text="Option name"/>
                                (<c:out value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="highlight input-xxlarge" id="name${counter.index}"
                                            path="descriptionsList[${counter.index}].name"/>
                        ...
                        <div class="controls">
                            ...
                            <div class="controls">
                                <form:select path="customerOptionType">
                                    ...
                                    <s:message code="label.product.productoption.type.select" text="Select"
                                               var="vSelect"/>
                                    <s:message code="label.product.productoption.type.radio" text="Radio" var="vRadio"/>
                                    <s:message code="label.product.productoption.type.checkbox" text="Checkbox"
                                               var="vCheckbox"/>
                                ...
                                <span class="help-inline"><form:errors path="customerOptionType"
                                                                       cssClass="error"/></span>
                            </div>
