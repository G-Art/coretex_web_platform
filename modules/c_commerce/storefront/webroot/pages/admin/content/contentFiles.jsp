    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="contentFiles"
                           action="${saveContentFiles}">
                    ...
                    <div class="form-actions">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-success"><s:message code="button.label.upload.files"
                                                                                     text="Upload files"/></button>
