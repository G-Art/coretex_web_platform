        ...
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <h3>
                    <c:choose>
                        <c:when test="${content.id!=null && content.id>0}">
                            <s:message code="label.content.manage.content" text="Manage content"/> <c:out
                                value="${content.code}"/>
                        </c:when>
                        <c:otherwise>
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="content" action="${saveContent}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.content.page.displaymainmenu"
                                          text="Show this page in main menu"/></label>
                        <div class="controls">
                    ...
                    <c:forEach items="${content.descriptions}" var="description" varStatus="counter">
                        ...
                        <textarea cols="30" id="descriptions[${counter.index}].description" class="ckeditor"
                                  name="descriptions[${counter.index}].description">
                        ...
                        <c:if test="${boxes==null}">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><form:errors
                                            path="descriptions[${counter.index}].metatagTitle" cssClass="error"/></span>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><form:errors
                                            path="descriptions[${counter.index}].metatagKeywords"
                                            cssClass="error"/></span>
                                </div>
                            </div>
                            <c:if test="${productGroups!=null}">
                                <div class="control-group">
                                    <label><s:message code="label.product.customGroup.title"
                                                      text="Product group"/></label>
                                    <div class="controls">
                                        ...
                                        <span class="help-inline"><form:errors path="productGroup"
                                                                               cssClass="error"/></span>
                                    </div>
                                </div>
                            </c:if>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><form:errors
                                            path="descriptions[${counter.index}].metatagDescription"
                                            cssClass="error"/></span>
                                </div>
                            </div>
                        </c:if>
